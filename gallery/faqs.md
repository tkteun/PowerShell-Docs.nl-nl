...
Het is niet mogelijk om te hurk itemnamen. Als u denkt dat een bestaand item heeft genomen de naam die aansluit bij uw object meer, probeer [contact opnemen met de eigenaar van het item](./how-to/working-with-items/contacting-item-owners.md). Als u niet antwoord binnen een paar weken ontvangen, kunt u contact op met ondersteuning en het team PowerShell Gallery ziet er het.

## <a name="how-do-i-claim-ownership-for-items-"></a>Hoe kan ik eigendom van items aanspraak maken?

Bekijk [Item eigenaars beheren op PowerShellGallery.com](./how-to/publishing-items/managing-item-owners.md) voor meer informatie.
...
Wij raden de PowerShell-community samenwerken om geschillen die zich tussen item eigenaren en de eigenaren van andere items voordoen kunnen op te lossen.  We hebben ontworpen een [geschil omzettingsproces](./how-to/getting-support/dispute-resolution.md) die we vragen u moet uitvoeren voordat PowerShellGallery.com beheerders intercede.