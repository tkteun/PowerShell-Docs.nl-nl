...
---
# <a name="dsc-for-linux-nxuser-resource"></a><span data-ttu-id="8c7d2-103">DSC voor Linux nxUser-resource</span><span class="sxs-lookup"><span data-stu-id="8c7d2-103">DSC for Linux nxUser Resource</span></span>

<span data-ttu-id="8c7d2-104">De **nxUser** -resource in Power shell desired state Configuration (DSC) biedt een mechanisme voor het beheren van lokale gebruikers op een Linux-knoop punt.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-104">The **nxUser** resource in PowerShell Desired State Configuration (DSC) provides a mechanism to manage local users on a Linux node.</span></span>
...
## <a name="properties"></a><span data-ttu-id="8c7d2-106">Eigenschappen</span><span class="sxs-lookup"><span data-stu-id="8c7d2-106">Properties</span></span>

|<span data-ttu-id="8c7d2-107">Eigenschap</span><span class="sxs-lookup"><span data-stu-id="8c7d2-107">Property</span></span> |<span data-ttu-id="8c7d2-108">Hiermee wordt de account naam aangegeven waarvoor u een specifieke status wilt waarborgen.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-108">Indicates the account name for which you want to ensure a specific state.</span></span> |
|---|---|
|<span data-ttu-id="8c7d2-109">UserName</span><span class="sxs-lookup"><span data-stu-id="8c7d2-109">UserName</span></span> |<span data-ttu-id="8c7d2-110">Hiermee geeft u de locatie op waar u de status van een bestand of map wilt controleren.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-110">Specifies the location where you want to ensure the state for a file or directory.</span></span> |
|<span data-ttu-id="8c7d2-111">FullName</span><span class="sxs-lookup"><span data-stu-id="8c7d2-111">FullName</span></span> |<span data-ttu-id="8c7d2-112">Een teken reeks die de volledige naam bevat die moet worden gebruikt voor het gebruikers account.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-112">A string that contains the full name to use for the user account.</span></span> |
|<span data-ttu-id="8c7d2-113">Beschrijving</span><span class="sxs-lookup"><span data-stu-id="8c7d2-113">Description</span></span> |<span data-ttu-id="8c7d2-114">De beschrijving voor het gebruikers account.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-114">The description for the user account.</span></span> |
|<span data-ttu-id="8c7d2-115">Wachtwoord</span><span class="sxs-lookup"><span data-stu-id="8c7d2-115">Password</span></span> |<span data-ttu-id="8c7d2-116">De hash van het wacht woord van de gebruiker in het juiste formulier voor de Linux-computer.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-116">The hash of the users password in the appropriate form for the Linux computer.</span></span> <span data-ttu-id="8c7d2-117">Normaal gesp roken is dit een gezouten SHA-256-of SHA-512-hash.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-117">Typically, this is a salted SHA-256, or SHA-512 hash.</span></span> <span data-ttu-id="8c7d2-118">Op Debian en Ubuntu Linux kan deze waarde worden gegenereerd met de `mkpasswd` opdracht.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-118">On Debian and Ubuntu Linux, this value can be generated with the `mkpasswd` command.</span></span> <span data-ttu-id="8c7d2-119">Voor andere Linux-distributies kan de cryptografie methode van de cryptografie bibliotheek van python worden gebruikt voor het genereren van de hash.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-119">For other Linux distros, the crypt method of Python's Crypt library can be used to generate the hash.</span></span> |
|<span data-ttu-id="8c7d2-120">Uitgeschakeld</span><span class="sxs-lookup"><span data-stu-id="8c7d2-120">Disabled</span></span> |<span data-ttu-id="8c7d2-121">Hiermee wordt aangegeven of het account is ingeschakeld.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-121">Indicates whether the account is enabled.</span></span> <span data-ttu-id="8c7d2-122">Stel deze eigenschap in op `$true` om ervoor te zorgen dat dit account is uitgeschakeld en stel dit in op `$false` om ervoor te zorgen dat deze is ingeschakeld.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-122">Set this property to `$true` to ensure that this account is disabled, and set it to `$false` to ensure that it is enabled.</span></span> |
|<span data-ttu-id="8c7d2-123">PasswordChangeRequired</span><span class="sxs-lookup"><span data-stu-id="8c7d2-123">PasswordChangeRequired</span></span> |<span data-ttu-id="8c7d2-124">Hiermee wordt aangegeven of de gebruiker het wacht woord kan wijzigen.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-124">Indicates whether the user can change the password.</span></span> <span data-ttu-id="8c7d2-125">Stel deze eigenschap in op `$true` om ervoor te zorgen dat de gebruiker het wacht woord niet kan wijzigen en stel in om de gebruiker in staat te stellen `$false` het wacht woord te wijzigen.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-125">Set this property to `$true` to ensure that the user cannot change the password, and set it to `$false` to allow the user to change the password.</span></span> <span data-ttu-id="8c7d2-126">De standaardwaarde is `$false`.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-126">The default value is `$false`.</span></span> <span data-ttu-id="8c7d2-127">Deze eigenschap wordt alleen geëvalueerd als het gebruikers account niet eerder bestaat en wordt gemaakt.</span><span class="sxs-lookup"><span data-stu-id="8c7d2-127">This property is only evaluated if the user account did not exist previously and is being created.</span></span> |
