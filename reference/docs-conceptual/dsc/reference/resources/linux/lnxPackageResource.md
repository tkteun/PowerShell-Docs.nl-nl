...
|PackageGroup |Als `$true`, wordt de **naam** naar verwachting de naam van een pakket groep voor gebruik met een **PackageManager**. **PackageGroup** is niet geldig voor het opgeven van een **bestandspad**. |
