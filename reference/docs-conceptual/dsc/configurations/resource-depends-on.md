...
In het volgende voor beeld wordt een firewall regel geconfigureerd na het inschakelen en configureren van het open bare profiel.
...
Wanneer u de configuratie toepast, wordt het Firewall profiel altijd eerst geconfigureerd, ongeacht de volg orde waarin de resource blokken worden gedefinieerd. Als u de configuratie toepast, moet u ervoor zorgen dat u de bestaande configuratie van de doel knooppunten noteert zodat u deze desgewenst kunt herstellen.
...
Als u de bovenstaande configuratie hierboven hebt toegepast, kunt u de sleutels omkeren om alle wijzigingen ongedaan te maken. In het bovenstaande voor beeld wordt de firewall regel en het profiel uitgeschakeld wanneer u de **ingeschakelde** sleutel instelt op false. Wijzig het voor beeld naar wens om te voldoen aan de vorige geconfigureerde status van uw doel knooppunt.
...
- [Afhankelijkheden tussen knoop punten gebruiken](./crossNodeDependencies.md)
