...
U kunt bijvoorbeeld het volgende doen om elk knoop punt een eigenschap te geven `LogPath` :
...
Elk MOF-bestand krijgt een naam met de `NodeName` eigenschap van de bijbehorende matrix vermelding.
