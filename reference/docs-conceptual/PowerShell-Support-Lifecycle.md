...
| Power shell 6,2           |   Mrt-2019   |                                                                                                                                               |
| Power shell 6,1           |   Sep-2018   | Gebouwd op .NET Core 2,1.                                                                                                                       |
| Power shell 6,0           |   Jan-2018   | First release, gebouwd op .NET Core 2,0. Installeerbaar op Windows, Linux en macOS.                                                              |
