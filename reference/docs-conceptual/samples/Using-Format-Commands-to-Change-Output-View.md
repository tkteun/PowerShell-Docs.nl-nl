...
Met de **indeling hele** cmdlet, kunt u slechts één eigenschap tegelijk weergeven. Dit maakt het handig voor het weergeven van eenvoudige lijsten die slechts één element per regel. Als u een eenvoudige lijst, stel de waarde van de **kolom** parameter 1 door te typen:
