...
### <a name="use-tagspsedition_core-to-search-items-compatible-with-powershell-core-edition"></a>Gebruik Tags: ' PSEdition_Core ' om items te zoeken die compatibel zijn met Power shell Core Edition.

![Zoek resultaten voor items die compatibel zijn met Core PSEdition](../../Images/searchresultswithpseditions.PNG)

### <a name="use-tagspsedition_desktop-to-search-items-compatible-with-powershell-desktop-edition"></a>Gebruik Tags: ' PSEdition_Desktop ' om items te zoeken die compatibel zijn met Power shell Desktop Edition.
...
Koptags "Compatibility1" "Compatibility2"
...
Koptags "PSEdition_Core" "Windows" "Linux"
