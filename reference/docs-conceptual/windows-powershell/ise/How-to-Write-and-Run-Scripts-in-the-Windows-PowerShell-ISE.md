...
3. Selecteer een bestands type in het vak **Opslaan als type** . Selecteer bijvoorbeeld Power shell-scripts () in het vak **Opslaan als type** `*.ps1` .
4. Klik op **Opslaan** .
