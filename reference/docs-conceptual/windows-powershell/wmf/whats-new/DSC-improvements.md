...
- Bestands naam in de opslag plaats voor pull-configuratie
  ...
  Azure Automation Service naam heeft MOF-bestanden gegenereerd als `<ConfigurationName>.<NodeName>.mof` . De onderstaande configuratie compileert daarom met PartialOne. localhost. mof.
