...
|**Lijsten**<br /> Voert `String`|`'<Current user>'`|Auteur van deze module. Als er geen waarde is opgegeven, `New-ModuleManifest` wordt de huidige gebruiker gebruikt. <br /> Voorbeeld: `Author = 'AuthorNameHere'`|
