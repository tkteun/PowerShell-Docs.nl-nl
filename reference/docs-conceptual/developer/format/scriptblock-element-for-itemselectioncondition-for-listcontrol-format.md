...
Hiermee geeft u het script op waarmee de voor waarde wordt geactiveerd. Wanneer dit script wordt geëvalueerd als `true`, wordt aan de voor waarde voldaan en wordt het lijst item gebruikt. Dit element wordt gebruikt bij het definiëren van een lijst weergave.
...
Als dit element wordt gebruikt, kunt u het element `PropertyName` niet opgeven wanneer u de selectie voorwaarde definieert.
