...
[TypeName-element voor EntrySelectedBy voor List entry (indeling)](/powershell/developer/format/typename-element-for-entryselectedby-for-listcontrol-format)
