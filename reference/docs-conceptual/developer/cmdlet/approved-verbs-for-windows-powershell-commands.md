...
De `New`-opdracht wordt gebruikt om een nieuwe resource te maken.
De `Set`-opdracht wordt gebruikt om een bestaande resource te wijzigen, waarbij u eventueel de resource maakt als deze niet bestaat, zoals de `Set-Variable`-cmdlet.

### <a name="find-vs-search"></a>Zoeken versus zoeken
De `Find`-opdracht wordt gebruikt om een object te zoeken.
De `Search`-opdracht wordt gebruikt om een verwijzing naar een resource in een container te maken.

### <a name="get-vs-read"></a>Ophalen versus lezen
De `Get`-opdracht wordt gebruikt voor het ophalen van een resource, zoals een bestand.
De `Read`-opdracht wordt gebruikt om informatie op te halen uit een bron, zoals een bestand.
...
De `Start`-opdracht wordt gebruikt om een bewerking te starten die over het algemeen een asynchrone bewerking is, zoals het starten van een proces.
...
|[Wissen](/dotnet/api/System.Management.Automation.VerbsCommon.Clear) (CL)|Hiermee worden alle resources uit een container verwijderd, maar wordt de container niet verwijderd. Met de cmdlet `Clear-Content` wordt bijvoorbeeld de inhoud van een bestand verwijderd, maar wordt het bestand niet verwijderd.|Gebruik voor deze actie geen woorden zoals flush, erase, release, unmarkeren, demarkering, of opheffen.|
...
|[Kopiëren](/dotnet/api/System.Management.Automation.VerbsCommon.Copy) (CP)|Kopieert een resource naar een andere naam of naar een andere container. De `Copy-Item`-cmdlet die wordt gebruikt voor toegang tot opgeslagen gegevens, kopieert bijvoorbeeld een item van de ene locatie in het gegevens archief naar een andere locatie.|Gebruik voor deze actie geen woorden zoals dupliceren, klonen, repliceren of synchroniseren.|
...
|[Nieuw](/dotnet/api/System.Management.Automation.VerbsCommon.New) (n)|Hiermee maakt u een resource. (De term `Set` kan ook worden gebruikt bij het maken van een resource die gegevens bevat, zoals de cmdlet `Set-Variable`.)|Gebruik voor deze actie geen woorden zoals maken, genereren, bouwen, maken of toewijzen.|
...
|[Verwijderen](/dotnet/api/System.Management.Automation.VerbsCommon.Remove) (r)|Hiermee verwijdert u een resource uit een container. De `Remove-Variable` cmdlet verwijdert bijvoorbeeld een variabele en de bijbehorende waarde. Deze term is gekoppeld aan `Add`.|Gebruik voor deze actie geen woorden zoals wissen, knippen, afstoten, verwijderen of wissen.|
|[Rename](/dotnet/api/System.Management.Automation.VerbsCommon.Rename) (RN)|Hiermee wordt de naam van een resource gewijzigd. Bijvoorbeeld, de cmdlet `Rename-Item`, die wordt gebruikt voor toegang tot opgeslagen gegevens, wijzigt de naam van een item in het gegevens archief.|Gebruik voor deze actie geen term zoals wijzigen.|
...
|[Selecteren](/dotnet/api/System.Management.Automation.VerbsCommon.Select) (SC)|Hiermee wordt een bron in een container gezocht. Met de cmdlet `Select-String` vindt u bijvoorbeeld tekst in teken reeksen en bestanden.|Gebruik voor deze actie geen woorden zoals zoeken of zoeken.|
|[Set](/dotnet/api/System.Management.Automation.VerbsCommon.Set) (s)|Vervangt gegevens over een bestaande resource of maakt een resource die een aantal gegevens bevat. De `Set-Date`-cmdlet wijzigt bijvoorbeeld de systeem tijd op de lokale computer. (De term `New` kan ook worden gebruikt om een resource te maken.) Deze term is gekoppeld aan `Get`.|Gebruik voor deze actie geen woorden zoals schrijven, opnieuw instellen, toewijzen of configureren.|
...
|[Splitsen](/dotnet/api/System.Management.Automation.VerbsCommon.Split) (SL)|Scheidt delen van een resource. De `Split-Path` cmdlet retourneert bijvoorbeeld verschillende delen van een pad. Deze term is gekoppeld aan `Join`.|Gebruik voor deze actie geen term die afzonderlijk wordt gebruikt.|
...
|[Opnieuw opstarten](/dotnet/api/System.Management.Automation.VerbsLifecycle.Restart) (RT)|Hiermee stopt u een bewerking en start u deze opnieuw. De `Restart-Service`-cmdlet wordt bijvoorbeeld gestopt en vervolgens wordt een service gestart.|Gebruik voor deze actie geen term zoals recyclen.|
|[Hervatten](/dotnet/api/System.Management.Automation.VerbsLifecycle.Resume) (ru)|Hiermee wordt een bewerking gestart die is onderbroken. Met de cmdlet `Resume-Service` wordt bijvoorbeeld een service gestart die is onderbroken. Deze term is gekoppeld aan `Suspend`.||
|[Starten](/dotnet/api/System.Management.Automation.VerbsLifecycle.Start) (SA)|Initieert een bewerking. Met de cmdlet `Start-Service` wordt bijvoorbeeld een service gestart. Deze term is gekoppeld aan `Stop`.|Gebruik voor deze actie geen woorden zoals starten, initiëren of opstarten.|
...
|[Wachten](/dotnet/api/System.Management.Automation.VerbsLifecycle.Wait) (w)|Hiermee wordt een bewerking onderbroken totdat een opgegeven gebeurtenis optreedt. De `Wait-Job`-cmdlet onderbreekt bijvoorbeeld bewerkingen totdat een of meer van de achtergrond taken zijn voltooid.|Gebruik voor deze actie geen woorden zoals de slaap stand of pauzeren.|
