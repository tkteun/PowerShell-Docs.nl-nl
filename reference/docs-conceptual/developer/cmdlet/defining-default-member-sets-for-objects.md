...
In de volgende uitvoer ziet u de standaard eigenschappen die worden geretourneerd door de [indeling-List-](/powershell/module/Microsoft.PowerShell.Utility/Format-List) cmdlet. Alleen de eigenschappen `Id`, `Handles`, `CPU` en `Name` worden geretourneerd voor elk proces object.
