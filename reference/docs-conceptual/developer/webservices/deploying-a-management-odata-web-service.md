...
Nadat u alle stappen hebt voltooid die nodig zijn om een management OData-webservice te maken, moet u deze implementeren als een webtoepassing in IIS.
...
1. Maak een map voor uw webtoepassing in de map IIS `WWWRoot`.
...
4. Een groep van toepassingen maken en configureren.

5. Configureer verificatie voor de site.

6. Configureer de firewall.

7. Start de site.

De volgende Windows Power shell-scripts laten zien hoe u een management OData-webservice implementeert.
