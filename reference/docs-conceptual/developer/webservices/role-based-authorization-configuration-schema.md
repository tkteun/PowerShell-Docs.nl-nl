...
Het [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) -voor beeld maakt gebruik van XML-bestanden voor het configureren van het autorisatie beleid. De volgende XSD definieert het schema dat wordt gebruikt voor deze bestanden.
