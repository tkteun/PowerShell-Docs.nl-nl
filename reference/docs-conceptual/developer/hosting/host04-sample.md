...
---
# <a name="host04-sample"></a><span data-ttu-id="58ab6-102">Voorbeeld Host04</span><span class="sxs-lookup"><span data-stu-id="58ab6-102">Host04 Sample</span></span>

<span data-ttu-id="58ab6-103">Dit voor beeld laat zien hoe u een interactieve op een console gebaseerde host-toepassing bouwt waarmee opdrachten worden gelezen vanaf de opdracht regel, de opdrachten worden uitgevoerd en de resultaten vervolgens worden weer gegeven in de console.</span><span class="sxs-lookup"><span data-stu-id="58ab6-103">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="58ab6-104">Deze hosttoepassing biedt ook ondersteuning voor het weer geven van prompts waarmee de gebruiker meerdere keuzes kan opgeven.</span><span class="sxs-lookup"><span data-stu-id="58ab6-104">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="58ab6-105">Vereisten</span><span class="sxs-lookup"><span data-stu-id="58ab6-105">Requirements</span></span>

 <span data-ttu-id="58ab6-106">Voor dit voor beeld is Windows Power Shell 2,0 vereist.</span><span class="sxs-lookup"><span data-stu-id="58ab6-106">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="58ab6-107">Hier ziet u</span><span class="sxs-lookup"><span data-stu-id="58ab6-107">Demonstrates</span></span>

- <span data-ttu-id="58ab6-108">Het maken van een aangepaste host waarvan de klassen zijn afgeleid van de klasse [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , de klasse [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) en de klasse [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) .</span><span class="sxs-lookup"><span data-stu-id="58ab6-108">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="58ab6-109">Het bouwen van een console toepassing die gebruikmaakt van deze host klassen om een interactieve Windows Power shell-shell te bouwen.</span><span class="sxs-lookup"><span data-stu-id="58ab6-109">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="58ab6-110">Een `$profile` variabele maken en de volgende profielen laden.</span><span class="sxs-lookup"><span data-stu-id="58ab6-110">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="58ab6-111">huidige gebruiker, huidige host</span><span class="sxs-lookup"><span data-stu-id="58ab6-111">current user, current host</span></span>

  - <span data-ttu-id="58ab6-112">huidige gebruiker, alle hosts</span><span class="sxs-lookup"><span data-stu-id="58ab6-112">current user, all hosts</span></span>

  - <span data-ttu-id="58ab6-113">alle gebruikers, huidige host</span><span class="sxs-lookup"><span data-stu-id="58ab6-113">all users, current host</span></span>

  - <span data-ttu-id="58ab6-114">alle gebruikers, alle hosts</span><span class="sxs-lookup"><span data-stu-id="58ab6-114">all users, all hosts</span></span>

- <span data-ttu-id="58ab6-115">Implementeer de interface [System. Management. Automation. host. Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) .</span><span class="sxs-lookup"><span data-stu-id="58ab6-115">Implement the [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example"></a><span data-ttu-id="58ab6-116">Voorbeeld</span><span class="sxs-lookup"><span data-stu-id="58ab6-116">Example</span></span>

 <span data-ttu-id="58ab6-117">In dit voor beeld kan de gebruiker opdrachten invoeren op de opdracht regel, worden deze opdrachten verwerkt en worden de resultaten afgedrukt.</span><span class="sxs-lookup"><span data-stu-id="58ab6-117">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example"></a><span data-ttu-id="58ab6-118">Voorbeeld</span><span class="sxs-lookup"><span data-stu-id="58ab6-118">Example</span></span>

 <span data-ttu-id="58ab6-119">De volgende code is de implementatie van de klasse [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) die wordt gebruikt door deze hosttoepassing.</span><span class="sxs-lookup"><span data-stu-id="58ab6-119">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="58ab6-120">Deze elementen die niet zijn geïmplementeerd, genereren een uitzonde ring of retour neren niets.</span><span class="sxs-lookup"><span data-stu-id="58ab6-120">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example"></a><span data-ttu-id="58ab6-121">Voorbeeld</span><span class="sxs-lookup"><span data-stu-id="58ab6-121">Example</span></span>

 <span data-ttu-id="58ab6-122">De volgende code is de implementatie van de klasse [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) die wordt gebruikt door deze hosttoepassing.</span><span class="sxs-lookup"><span data-stu-id="58ab6-122">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example"></a><span data-ttu-id="58ab6-123">Voorbeeld</span><span class="sxs-lookup"><span data-stu-id="58ab6-123">Example</span></span>

 <span data-ttu-id="58ab6-124">De volgende code is de implementatie van de klasse [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) die wordt gebruikt door deze hosttoepassing.</span><span class="sxs-lookup"><span data-stu-id="58ab6-124">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="58ab6-125">Deze elementen die niet zijn geïmplementeerd, genereren een uitzonde ring of retour neren niets.</span><span class="sxs-lookup"><span data-stu-id="58ab6-125">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="58ab6-126">Zie ook</span><span class="sxs-lookup"><span data-stu-id="58ab6-126">See Also</span></span>

 [<span data-ttu-id="58ab6-127">System. Management. Automation. host. PSHost</span><span class="sxs-lookup"><span data-stu-id="58ab6-127">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="58ab6-128">System. Management. Automation. host. Pshostuserinterface</span><span class="sxs-lookup"><span data-stu-id="58ab6-128">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="58ab6-129">System. Management. Automation. host. Pshostrawuserinterface</span><span class="sxs-lookup"><span data-stu-id="58ab6-129">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
