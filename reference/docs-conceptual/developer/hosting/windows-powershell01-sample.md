...
---
# <a name="windows-powershell01-sample"></a><span data-ttu-id="5ba42-103">Voorbeeld Windows PowerShell01</span><span class="sxs-lookup"><span data-stu-id="5ba42-103">Windows PowerShell01 Sample</span></span>

<span data-ttu-id="5ba42-104">In dit voor beeld ziet u hoe u een [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) -object gebruikt om de functionaliteit van een runs Pace te beperken.</span><span class="sxs-lookup"><span data-stu-id="5ba42-104">This sample shows how to use an [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) object to limit the functionality of a runspace.</span></span> <span data-ttu-id="5ba42-105">De uitvoer van dit voor beeld laat zien hoe u de taal modus van de runs Pace kunt beperken, hoe u een cmdlet als privé markeert, hoe u cmdlets en providers toevoegt en verwijdert, hoe u een proxy opdracht toevoegt, en meer.</span><span class="sxs-lookup"><span data-stu-id="5ba42-105">The output of this sample demonstrates how to restrict the language mode of the runspace, how to mark a cmdlet as private, how to add and remove cmdlets and providers, how to add a proxy command, and more.</span></span> <span data-ttu-id="5ba42-106">Dit voor beeld is gericht op het programmatisch beperken van de runs Pace.</span><span class="sxs-lookup"><span data-stu-id="5ba42-106">This sample concentrates on how to restrict the runspace programmatically.</span></span> <span data-ttu-id="5ba42-107">Het uitvoeren van scripts voor het beperken van de runs Pace bevat de opdrachten $ExecutionContext. SessionState. LanguageMode en PSSessionConfiguration.</span><span class="sxs-lookup"><span data-stu-id="5ba42-107">Scripting alternatives to restricting the runspace include the $ExecutionContext.SessionState.LanguageMode and PSSessionConfiguration commands.</span></span>

## <a name="requirements"></a><span data-ttu-id="5ba42-108">Vereisten</span><span class="sxs-lookup"><span data-stu-id="5ba42-108">Requirements</span></span>

<span data-ttu-id="5ba42-109">Voor dit voor beeld is Windows Power Shell 2,0 vereist.</span><span class="sxs-lookup"><span data-stu-id="5ba42-109">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="5ba42-110">Demonstreert</span><span class="sxs-lookup"><span data-stu-id="5ba42-110">Demonstrates</span></span>

<span data-ttu-id="5ba42-111">In dit voor beeld ziet u het volgende:</span><span class="sxs-lookup"><span data-stu-id="5ba42-111">This sample demonstrates the following:</span></span>

- <span data-ttu-id="5ba42-112">De taal beperken door deSystem.Management.Automation.Runspaces.Initialsessionstate in te stellen [ . Eigenschap Languagemode](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.LanguageMode) .</span><span class="sxs-lookup"><span data-stu-id="5ba42-112">Restricting the language by setting the [System.Management.Automation.Runspaces.Initialsessionstate.Languagemode](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.LanguageMode) property.</span></span>

- <span data-ttu-id="5ba42-113">Aliassen toevoegen aan de oorspronkelijke sessie status met behulp van [System. Management. Automation. Runspaces. Sessionstatealiasentry? Displayproperty = FullName](/dotnet/api/System.Management.Automation.Runspaces.SessionStateAliasEntry) -object.</span><span class="sxs-lookup"><span data-stu-id="5ba42-113">Adding aliases to the initial session state by using a [System.Management.Automation.Runspaces.Sessionstatealiasentry?Displayproperty=Fullname](/dotnet/api/System.Management.Automation.Runspaces.SessionStateAliasEntry) object.</span></span>

- <span data-ttu-id="5ba42-114">Het markeren van opdrachten als persoonlijk.</span><span class="sxs-lookup"><span data-stu-id="5ba42-114">Marking commands as private.</span></span>

- <span data-ttu-id="5ba42-115">Het verwijderen van providers uit de oorspronkelijke sessie status met behulp van de [System.Management.Automation.Runspaces.Initialsessionstate. Eigenschap providers](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Providers) .</span><span class="sxs-lookup"><span data-stu-id="5ba42-115">Removing providers from the initial session state by using the [System.Management.Automation.Runspaces.Initialsessionstate.Providers](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Providers) property.</span></span>

- <span data-ttu-id="5ba42-116">Het verwijderen van opdrachten uit de oorspronkelijke sessie status met behulp van de eigenschap [System.Management.Automation.Runspaces.Initialsessionstate. commands](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Commands) .</span><span class="sxs-lookup"><span data-stu-id="5ba42-116">Removing commands from the initial session state by using the [System.Management.Automation.Runspaces.Initialsessionstate.Commands](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState.Commands) property.</span></span>

- <span data-ttu-id="5ba42-117">Opdrachten en providers toevoegen aan het [ tialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) -object vanSystem.Management.Automation.Runspaces.Ini.</span><span class="sxs-lookup"><span data-stu-id="5ba42-117">Adding commands and providers to the [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) object.</span></span>

## <a name="example"></a><span data-ttu-id="5ba42-118">Voorbeeld</span><span class="sxs-lookup"><span data-stu-id="5ba42-118">Example</span></span>

<span data-ttu-id="5ba42-119">In dit voor beeld ziet u verschillende manieren om de functionaliteit van een runs Pace te beperken.</span><span class="sxs-lookup"><span data-stu-id="5ba42-119">This sample shows several ways to limit the functionality of a runspace.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="5ba42-120">Zie ook</span><span class="sxs-lookup"><span data-stu-id="5ba42-120">See Also</span></span>

[<span data-ttu-id="5ba42-121">Een Windows PowerShell-hosttoepassing schrijven</span><span class="sxs-lookup"><span data-stu-id="5ba42-121">Writing a Windows PowerShell Host Application</span></span>](./writing-a-windows-powershell-host-application.md)
