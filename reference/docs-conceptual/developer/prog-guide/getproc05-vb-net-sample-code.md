...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="af267-102">GetProc05-codevoorbeeld (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="af267-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="af267-103">Dit is de volledige VB.NET-code voor de voor beeld-cmdlet GetProc05.</span><span class="sxs-lookup"><span data-stu-id="af267-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="af267-104">Zie ook</span><span class="sxs-lookup"><span data-stu-id="af267-104">See Also</span></span>

[<span data-ttu-id="af267-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="af267-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)
