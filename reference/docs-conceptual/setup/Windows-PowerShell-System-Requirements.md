...
Zie voor meer informatie over het toevoegen of de Windows PowerShell 2.0-engine installeren en toe te voegen of de installatie van de vereiste versies van Microsoft .NET Framework [installeren van de Windows PowerShell 2.0-Engine](Installing-the-Windows-PowerShell-2.0-Engine.md). Zie voor meer informatie over het starten van de Windows PowerShell 2.0-engine [vanaf de Windows PowerShell 2.0-Engine](Starting-the-Windows-PowerShell-2.0-Engine.md).
