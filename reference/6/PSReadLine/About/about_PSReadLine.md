...
- VI-opdracht modus: `<Delete>` , `<x>` , `<d,l>` , `<d,Space>`
...
Hiermee verwijdert u de huidige regel, waarbij u ongedaan maken inschakelt.
...
- VI-opdracht modus: `<RightArrow>` , `<Space>` , `<l>`
...
- Emacs: `<Alt+=>`
- VI Invoeg modus: `<Ctrl+Space>`
- VI-opdracht modus: `<Ctrl+Space>`
...
Deze functie wordt gebruikt door Get-PSReadLineKeyHandler en is waarschijnlijk niet nuttig in een aangepaste sleutel binding.
