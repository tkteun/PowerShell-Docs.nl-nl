...
> [!CAUTION]
> Als u een **SymbolicLink** maakt in een map in Windows, moet u een volledig gekwalificeerde pad gebruiken. Als u een relatief pad gebruikt, wordt de koppeling gemaakt als een koppeling naar een bestands type in plaats van een koppeling naar een directory-type.
