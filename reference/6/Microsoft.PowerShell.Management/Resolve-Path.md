...
Hiermee geeft u het Power shell-pad op dat moet worden omgezet. Deze parameter is vereist. U kunt ook een padtekenreeks door sluizen naar `Resolve-Path` . Joker tekens zijn toegestaan.
