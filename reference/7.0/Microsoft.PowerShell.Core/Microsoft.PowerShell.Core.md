...
---
# Module micro soft. Power shell. core

## Beschrijving

Deze sectie bevat de Help-onderwerpen voor de cmdlets die zijn geïnstalleerd met de module Power shell micro soft. Power shell. core. De kern module bevat cmdlets en providers die de basis functies van Power shell beheren.

## Micro soft. Power shell. core-cmdlets
...
### [Fout opsporing-taak](Debug-Job.md)
De uitvoering van een actieve achtergrond, externe of Power shell-werk stroom taak wordt ongebruikt.
...
### [REGI ster-ArgumentCompleter](Register-ArgumentCompleter.md)
