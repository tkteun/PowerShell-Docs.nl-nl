...
### <span data-ttu-id="2a04b-109">URI</span><span class="sxs-lookup"><span data-stu-id="2a04b-109">Uri</span></span>
...
### <span data-ttu-id="2a04b-115">SSHHostHashParam</span><span class="sxs-lookup"><span data-stu-id="2a04b-115">SSHHostHashParam</span></span>
...
### <span data-ttu-id="2a04b-140">Voor beeld 3: sessies op meerdere computers maken</span><span class="sxs-lookup"><span data-stu-id="2a04b-140">Example 3: Create sessions on multiple computers</span></span>
...
### <span data-ttu-id="2a04b-152">Voor beeld 5: een sessie maken op basis van een bestaande sessie</span><span class="sxs-lookup"><span data-stu-id="2a04b-152">Example 5: Create a session based on an existing session</span></span>
...
### <span data-ttu-id="2a04b-183">Voor beeld 11: een sessie optie maken</span><span class="sxs-lookup"><span data-stu-id="2a04b-183">Example 11: Create a session option</span></span>
...
### <span data-ttu-id="2a04b-283">-EnableNetworkAccess</span><span class="sxs-lookup"><span data-stu-id="2a04b-283">-EnableNetworkAccess</span></span>
...
<span data-ttu-id="2a04b-296">Deze para meter is geïntroduceerd in Power Shell 3,0.</span><span class="sxs-lookup"><span data-stu-id="2a04b-296">This parameter was introduced in PowerShell 3.0.</span></span>
...
<span data-ttu-id="2a04b-305">Deze para meter is geïntroduceerd in Power shell 6,0.</span><span class="sxs-lookup"><span data-stu-id="2a04b-305">This parameter was introduced in PowerShell 6.0.</span></span>
...
<span data-ttu-id="2a04b-314">Voordat u een andere poort gebruikt, moet u de WinRM-listener op de externe computer configureren om op die poort te Luis teren.</span><span class="sxs-lookup"><span data-stu-id="2a04b-314">Before using another port, you must configure the WinRM listener on the remote computer to listen at that port.</span></span> <span data-ttu-id="2a04b-315">Gebruik de volgende opdrachten om de listener te configureren:</span><span class="sxs-lookup"><span data-stu-id="2a04b-315">Use the following commands to configure the listener:</span></span>
...
<span data-ttu-id="2a04b-340">Deze para meter is geïntroduceerd in Power shell 6,0.</span><span class="sxs-lookup"><span data-stu-id="2a04b-340">This parameter was introduced in PowerShell 6.0.</span></span>
...
<span data-ttu-id="2a04b-349">De beperkings limiet geldt alleen voor de huidige opdracht, niet voor de sessie of voor de computer.</span><span class="sxs-lookup"><span data-stu-id="2a04b-349">The throttle limit applies only to the current command, not to the session or to the computer.</span></span>
...
<span data-ttu-id="2a04b-359">Deze para meter is geïntroduceerd in Power shell 6,0.</span><span class="sxs-lookup"><span data-stu-id="2a04b-359">This parameter was introduced in PowerShell 6.0.</span></span>
...
<span data-ttu-id="2a04b-367">Hiermee geeft u een ID-matrix van virtuele machines op.</span><span class="sxs-lookup"><span data-stu-id="2a04b-367">Specifies an array of ID of virtual machines.</span></span> <span data-ttu-id="2a04b-368">Met deze cmdlet wordt een interactieve sessie gestart met elk van de opgegeven virtuele machines.</span><span class="sxs-lookup"><span data-stu-id="2a04b-368">This cmdlet starts an interactive session with each of the specified virtual machines.</span></span> <span data-ttu-id="2a04b-369">Als u de virtuele machines wilt zien die voor u beschikbaar zijn, gebruikt u de volgende opdracht:</span><span class="sxs-lookup"><span data-stu-id="2a04b-369">To see the virtual machines that are available to you, use the following command:</span></span>
...
<span data-ttu-id="2a04b-378">De gebruikers naam en/of poort die is opgegeven als onderdeel van de hostnaam, hebben voor rang op de `-UserName` `-Port` para meters en, indien opgegeven.</span><span class="sxs-lookup"><span data-stu-id="2a04b-378">The user name and/or port specified as part of the host name takes precedence over the `-UserName` and `-Port` parameters, if specified.</span></span>
...
### <span data-ttu-id="2a04b-386">-SSHTransport</span><span class="sxs-lookup"><span data-stu-id="2a04b-386">-SSHTransport</span></span>
...
<span data-ttu-id="2a04b-412">Het subsysteem start een specifieke versie van Power shell met vooraf gedefinieerde para meters.</span><span class="sxs-lookup"><span data-stu-id="2a04b-412">The subsystem starts a specific version of PowerShell with predefined parameters.</span></span>
<span data-ttu-id="2a04b-413">Als het opgegeven subsysteem niet bestaat op de externe computer, mislukt de opdracht.</span><span class="sxs-lookup"><span data-stu-id="2a04b-413">If the specified subsystem does not exist on the remote computer, the command fails.</span></span>

<span data-ttu-id="2a04b-414">Als deze para meter niet wordt gebruikt, is de standaard het subsysteem Power shell.</span><span class="sxs-lookup"><span data-stu-id="2a04b-414">If this parameter is not used, the default is the 'powershell' subsystem.</span></span>
...
### <span data-ttu-id="2a04b-415">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="2a04b-415">CommonParameters</span></span>

<span data-ttu-id="2a04b-416">Deze cmdlet biedt ondersteuning voor de meest gebruikte parameters: -Debug, - ErrorAction, - ErrorVariable, - InformationAction, -InformationVariable, - OutVariable,-OutBuffer, - PipelineVariable - Verbose, - WarningAction en -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="2a04b-416">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="2a04b-417">Zie about_CommonParameters (voor meer informatie https://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="2a04b-417">For more information, see about_CommonParameters (https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="2a04b-418">INVOER</span><span class="sxs-lookup"><span data-stu-id="2a04b-418">INPUTS</span></span>

### <span data-ttu-id="2a04b-419">System. String, System. URI, System. Management. Automation. Runspaces. PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-419">System.String, System.URI, System.Management.Automation.Runspaces.PSSession</span></span>

<span data-ttu-id="2a04b-420">U kunt een teken reeks, URI of sessie object door sluizen naar deze cmdlet.</span><span class="sxs-lookup"><span data-stu-id="2a04b-420">You can pipe a string, URI, or session object to this cmdlet.</span></span>

## <span data-ttu-id="2a04b-421">UITVOER</span><span class="sxs-lookup"><span data-stu-id="2a04b-421">OUTPUTS</span></span>

### <span data-ttu-id="2a04b-422">System. Management. Automation. Runspaces. PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-422">System.Management.Automation.Runspaces.PSSession</span></span>

## <span data-ttu-id="2a04b-423">OPMERKINGEN</span><span class="sxs-lookup"><span data-stu-id="2a04b-423">NOTES</span></span>

- <span data-ttu-id="2a04b-424">Deze cmdlet maakt gebruik van de externe infra structuur van Power shell.</span><span class="sxs-lookup"><span data-stu-id="2a04b-424">This cmdlet uses the PowerShell remoting infrastructure.</span></span> <span data-ttu-id="2a04b-425">Als u deze cmdlet wilt gebruiken, moeten de lokale computer en alle externe computers worden geconfigureerd voor externe communicatie met Power shell.</span><span class="sxs-lookup"><span data-stu-id="2a04b-425">To use this cmdlet, the local computer and any remote computers must be configured for PowerShell remoting.</span></span> <span data-ttu-id="2a04b-426">Zie [about_Remote_Requirements](About/about_Remote_Requirements.md)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="2a04b-426">For more information, see [about_Remote_Requirements](About/about_Remote_Requirements.md).</span></span>
- <span data-ttu-id="2a04b-427">Als u een **PSSession** op de lokale computer wilt maken, start u Power shell met de optie als administrator uitvoeren.</span><span class="sxs-lookup"><span data-stu-id="2a04b-427">To create a **PSSession** on the local computer, start PowerShell with the Run as administrator option.</span></span>
- <span data-ttu-id="2a04b-428">Wanneer u klaar bent met de **PSSession** , gebruikt u de `Remove-PSSession` cmdlet om de **PSSession** te verwijderen en de bijbehorende resources vrij te geven.</span><span class="sxs-lookup"><span data-stu-id="2a04b-428">When you are finished with the **PSSession** , use the `Remove-PSSession` cmdlet to delete the **PSSession** and release its resources.</span></span>
- <span data-ttu-id="2a04b-429">De para meters **hostname** en **SSHConnection** zijn opgenomen vanaf Power shell 6,0.</span><span class="sxs-lookup"><span data-stu-id="2a04b-429">The **HostName** and **SSHConnection** parameter sets were included starting with PowerShell 6.0.</span></span>
  <span data-ttu-id="2a04b-430">Ze zijn toegevoegd om Power shell Remoting te bieden op basis van de Secure Shell (SSH).</span><span class="sxs-lookup"><span data-stu-id="2a04b-430">They were added to provide PowerShell remoting based on Secure Shell (SSH).</span></span> <span data-ttu-id="2a04b-431">SSH en Power shell worden ondersteund op meerdere platformen (Windows, Linux, macOS) en externe communicatie met Power shell werkt op deze platforms waarin Power shell en SSH zijn geïnstalleerd en geconfigureerd.</span><span class="sxs-lookup"><span data-stu-id="2a04b-431">Both SSH and PowerShell are supported on multiple platforms (Windows, Linux, macOS) and PowerShell remoting will work over these platforms where PowerShell and SSH are installed and configured.</span></span> <span data-ttu-id="2a04b-432">Dit is gescheiden van de vorige Windows-functie voor externe toegang die is gebaseerd op WinRM en veel van de specifieke WinRM-functies en-beperkingen zijn niet van toepassing.</span><span class="sxs-lookup"><span data-stu-id="2a04b-432">This is separate from the previous Windows only remoting that is based on WinRM and much of the WinRM specific features and limitations do not apply.</span></span> <span data-ttu-id="2a04b-433">Bijvoorbeeld: op WinRM gebaseerde quota's, sessie opties, aangepaste eindpunt configuratie en functies voor ontkoppelen/opnieuw verbinden worden op dit moment niet ondersteund.</span><span class="sxs-lookup"><span data-stu-id="2a04b-433">For example WinRM based quotas, session options, custom endpoint configuration, and disconnect/reconnect features are currently not supported.</span></span> <span data-ttu-id="2a04b-434">Zie voor meer informatie over het instellen van externe toegang tot Power shell [via SSH Power shell](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span><span class="sxs-lookup"><span data-stu-id="2a04b-434">For more information about how to set up PowerShell SSH remoting, see [PowerShell Remoting Over SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span></span>

## <span data-ttu-id="2a04b-435">GERELATEERDE KOPPELINGEN</span><span class="sxs-lookup"><span data-stu-id="2a04b-435">RELATED LINKS</span></span>

[<span data-ttu-id="2a04b-436">Connect-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-436">Connect-PSSession</span></span>](Connect-PSSession.md)

[<span data-ttu-id="2a04b-437">Verbinding verbreken-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-437">Disconnect-PSSession</span></span>](Disconnect-PSSession.md)

[<span data-ttu-id="2a04b-438">Enter-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-438">Enter-PSSession</span></span>](Enter-PSSession.md)

[<span data-ttu-id="2a04b-439">Afsluiten-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-439">Exit-PSSession</span></span>](Exit-PSSession.md)

[<span data-ttu-id="2a04b-440">Get-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-440">Get-PSSession</span></span>](Get-PSSession.md)

[<span data-ttu-id="2a04b-441">Invoke-opdracht</span><span class="sxs-lookup"><span data-stu-id="2a04b-441">Invoke-Command</span></span>](Invoke-Command.md)

[<span data-ttu-id="2a04b-442">Receive-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-442">Receive-PSSession</span></span>](Receive-PSSession.md)

[<span data-ttu-id="2a04b-443">Remove-PSSession</span><span class="sxs-lookup"><span data-stu-id="2a04b-443">Remove-PSSession</span></span>](Remove-PSSession.md)
