...
- <span data-ttu-id="f1695-121">`Get-Alias` -Haalt alle aliassen in de huidige sessie op.</span><span class="sxs-lookup"><span data-stu-id="f1695-121">`Get-Alias` - Gets all the aliases in the current session.</span></span>
