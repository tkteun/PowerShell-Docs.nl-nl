...
### Voor beeld 9: de security descriptor van een service wijzigen

In dit voor beeld wordt de **security descriptor** van een service gewijzigd.
...
De **security descriptor** wordt opgeslagen in de `$SDDL` variabele. `Set-Service` maakt gebruik van de para meter **name** om de **bits** -service op te geven. De para meter **SecurityDescriptorSddl** maakt gebruik `$SDDL` van om de **security descriptor** voor de **bits** -service te wijzigen.
