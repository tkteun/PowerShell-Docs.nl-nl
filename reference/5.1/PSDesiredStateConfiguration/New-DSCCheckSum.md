...
## BESCHRIJVING
De cmdlet **New-DSCCheckSum** genereert controlesom bestanden voor Windows Power shell-documenten voor desired state Configuration (DSC) en gecomprimeerde DSC-resources.
