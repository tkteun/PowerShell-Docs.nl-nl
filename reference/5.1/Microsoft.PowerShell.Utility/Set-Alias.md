...
Als u een nieuwe alias wilt maken, gebruikt u `Set-Alias` of `New-Alias` . Gebruik de cmdlet om een alias te verwijderen `Remove-Item` . Bijvoorbeeld `Remove-Item -Path Alias:aliasname`.
