...
> [!IMPORTANT]
> Er is een probleem met deze switch in Windows Power shell die is opgelost in Power shell 6,2 en hoger. Wanneer u **geen gebruik maakt** van de para meter **input object** , wordt de opdracht nog steeds opgesomd. U kunt dit probleem omzeilen door de **input object** -argument (en) positioneel door te geven.
