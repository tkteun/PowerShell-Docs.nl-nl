...
## BESCHRIJVING
Met de cmdlet **New-alias** maakt u een nieuwe alias in de huidige Windows Power shell-sessie.
Aliassen die zijn gemaakt met behulp van **New-alias** worden niet opgeslagen nadat u de sessie afsluit of Windows Power shell sluiten.
