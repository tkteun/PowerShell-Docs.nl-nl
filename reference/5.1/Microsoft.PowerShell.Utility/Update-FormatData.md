...
Bij het format teren van .NET-objecten gebruikt Windows Power shell de eerste opmaak definitie die wordt gevonden voor elk .NET-type. Als u de para meter **AppendPath** gebruikt, doorzoekt Windows Power shell de gegevens van de ingebouwde bestanden voordat deze de opmaak gegevens detecteert die u toevoegt.
...
Bij het format teren van .NET-objecten gebruikt Windows Power shell de eerste opmaak definitie die wordt gevonden voor elk .NET-type. Als u de para meter **PrependPath** gebruikt, doorzoekt Windows Power shell de gegevens van de bestanden die u toevoegt voordat de opmaak gegevens van de ingebouwde bestanden worden gevonden.
