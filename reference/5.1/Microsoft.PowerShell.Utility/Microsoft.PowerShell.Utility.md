...
## Micro soft. Power shell. Utility-cmdlets
...
Hiermee schakelt u fout opsporing op een of meer runspaces uit en worden alle in behandeling zijnde debugging stoppen vrijgegeven.
...
### [Ophalen-wille keurig](Get-Random.md)
...
Hiermee worden waarden uit een geïmporteerd. PSD1-bestand zonder de inhoud aan te roepen
...
Hiermee stelt u de waarde van een variabele.

### [Weer geven-opdracht](Show-Command.md)
...
### [Start-slaap stand](Start-Sleep.md)
...
### [Blok kering van bestand opheffen](Unblock-File.md)
...
### [Wacht debugger](Wait-Debugger.md)
...
Hiermee worden de opgegeven objecten verzonden naar de volgende opdracht in de pijp lijn.
