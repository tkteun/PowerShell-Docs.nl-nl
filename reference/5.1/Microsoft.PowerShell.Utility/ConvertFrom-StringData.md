...
### Voor beeld 2: een hier een teken reeks converteren met een opmerking
...
### Voor beeld 3: een teken reeks converteren naar een hash-tabel
...
### Voor beeld 4: ConvertFrom-StringData gebruiken in de sectie gegevens van een script
...
### Voor beeld 5: de pijplijn operator gebruiken om een teken reeks door te geven
...
### Voor beeld 6: Escape tekens gebruiken om nieuwe lijnen en retour tekens toe te voegen
...
### Voor beeld 7: back slash-escape teken gebruiken om een bestandspad correct weer te geven
