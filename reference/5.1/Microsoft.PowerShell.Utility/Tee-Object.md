...
`Tee-Object` maakt gebruik van Unicode (UTF-16LE)-code ring wanneer deze naar bestanden wordt geschreven. Als u een andere code ring nodig hebt, gebruikt u de `Out-File` cmdlet met de para meter **Encoding** .
