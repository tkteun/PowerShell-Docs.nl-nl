...
**Get-PSBreakpoint** is een van de verschillende cmdlets die zijn ontworpen voor het opsporen van fouten in Windows Power shell-scripts en-opdrachten. Zie about_Debuggers voor meer informatie over de Windows Power Shell-fout opsporing.
