...
Hiermee geeft u de eigenschappen op die met deze cmdlet worden uitgesloten van de bewerking. Joker tekens zijn toegestaan. Deze para meter is alleen effectief als de opdracht ook de **eigenschap** para meter bevat.
