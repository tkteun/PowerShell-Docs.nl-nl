...
**Remove-PSBreakpoint** is een van de verschillende cmdlets die zijn ontworpen voor het opsporen van fouten in Windows Power shell-scripts.
Zie about_Debuggers voor meer informatie over de Windows Power Shell-fout opsporing.
...
Als u de functie wilt opslaan, voegt u deze toe aan uw Windows Power shell-profiel.
