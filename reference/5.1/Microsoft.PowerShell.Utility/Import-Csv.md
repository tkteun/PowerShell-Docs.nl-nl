...
`Import-Csv` maakt gebruik van de byte-order-Mark (BOM) om de coderings indeling van het bestand te detecteren. Als het bestand geen stuk lijst heeft, wordt ervan uitgegaan dat de code ring UTF8 is.
