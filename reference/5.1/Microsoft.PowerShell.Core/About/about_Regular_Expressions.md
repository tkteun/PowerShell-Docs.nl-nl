...
In het volgende voor beeld wordt de meest recente **SUCCESSAUDIT** uit het Windows-beveiligings logboek opgeslagen. Met de gevoorziete reguliere expressie worden de gebruikers naam en het domein uit het bericht geëxtraheerd en opgeslagen onder de sleutels: **N** voor naam en **D** voor domein.
