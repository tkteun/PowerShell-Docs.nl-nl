...
Hierin vindt u een korte inleiding tot de logboek bron van de desired state Configuration (DSC) van Power shell. LANGE BESCHRIJVING

## <a name="long-description"></a>LANGE BESCHRIJVING

## <a name="how-to-use-the-dsc-log-resource"></a>DE DSC-LOGBOEK RESOURCE GEBRUIKEN
