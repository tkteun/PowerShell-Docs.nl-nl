...
> De tijdelijke oplossing is met behulp van de *modus-para meters* in uw reguliere expressie.
> U kunt meer informatie over de opties voor de modus in [reguliere expressies](/dotnet/standard/base-types/regular-expression-options) lezen
