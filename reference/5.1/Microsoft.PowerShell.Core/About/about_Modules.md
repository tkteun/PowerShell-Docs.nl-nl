...
- De **ALLUSERS** -locatie bevindt zich `$env:PROGRAMFILES\WindowsPowerShell\Modules` in Windows.
...
Zie [about_PSSnapins](about_PSSnapins.md)voor meer informatie over Power shell-modules.
...
U kunt ook een groepsbeleid instelling gebruiken, module logboek registratie inschakelen om module logboek registratie in te scha kelen in alle Power shell-sessies. Zie [about_EventLogs](about_EventLogs.md) en [about_Group_Policy_Settings](about_Group_Policy_Settings.md)voor meer informatie.
