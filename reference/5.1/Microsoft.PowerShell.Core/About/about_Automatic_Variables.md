...
Bevat de naam van de cultuur die momenteel wordt gebruikt in het besturings systeem. De cultuur bepaalt de weergave notatie van items, zoals getallen, valuta's en datums, en wordt opgeslagen in een object **System. Globalization. Culture info** . Gebruiken `Get-Culture` om de cultuur van de computer weer te geven. `$PSCulture` bevat de waarde van de eigenschap **naam** .
...
| Eigenschap                  | Beschrijving                                   |
| ------------------------- | --------------------------------------------- |
| **BuildVersion**          | Het build-nummer van de huidige versie       |
| **CLRVersion**            | De versie van de Common Language Runtime    |
|                           | -                                         |
...
|                           | Windows Server-en Windows-client versies.   |
|                           | Deze eigenschap heeft de waarde ' core ' voor     |
|                           | Power shell die wordt uitgevoerd onder Nano server of       |
|                           | Windows IOT.                                  |
