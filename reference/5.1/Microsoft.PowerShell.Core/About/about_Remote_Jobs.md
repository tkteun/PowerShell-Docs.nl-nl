...
U kunt de cmdlets gebruiken die het zelfstandige taak onderdeel (de taak-cmdlets) bevatten om elke taak te beheren die door elke cmdlet wordt gemaakt. Veel van de cmdlets met AsJob-para meters gebruiken geen externe Windows Power shell, zodat u ze zelfs kunt gebruiken op computers die niet zijn geconfigureerd voor externe toegang en die niet voldoen aan de vereisten voor externe toegang.
