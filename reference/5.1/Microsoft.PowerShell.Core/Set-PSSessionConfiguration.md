...
### Voor beeld 1: de thread Apartment-status wijzigen

```
PS C:\> Set-PSSessionConfiguration -Name "MaintenanceShell" -ThreadApartmentState STA
```

Met deze opdracht wordt de thread Apartment-status in de MaintenanceShell-configuratie gewijzigd in STA.
De wijziging is van kracht wanneer u de **WinRM** -service opnieuw start.

### Voor beeld 2: een sessie configuratie maken en wijzigen
...
### Voor beeld 3: resultaten weer geven
...
### Voor beeld 4: resultaten op verschillende manieren weer geven
...
Hiermee geeft u de instelling voor de status van de Apartment voor de threads in de sessie.
