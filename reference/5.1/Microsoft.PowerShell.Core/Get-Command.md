...
De opdracht maakt gebruik van de intrinsieke eigenschap **PSTypeNames** van alle objecten, waarmee de typen worden opgehaald die het object beschrijven. Als u de eigenschap **PSTypeNames** van een netwerk adapter wilt ophalen en niet de eigenschap **PSTypeNames** van een verzameling netwerk adapters, gebruikt de opdracht matrix notatie om de eerste netadapter op te halen die door de cmdlet wordt geretourneerd. Als u de eigenschap **PSTypeNames** van een netwerk adapter wilt ophalen en niet de eigenschap **PSTypeNames** van een verzameling netwerk adapters, gebruikt de opdracht matrix notatie om de eerste netadapter op te halen die door de cmdlet wordt geretourneerd.
...
- `Workflow`: Hiermee worden alle werk stromen opgehaald. Zie Inleiding tot de Windows Power shell-werk stroom voor meer informatie over werk stromen.
...
U kunt deze para meter naar de naam, **module** of de alias **PSSnapin**. De parameter naam die u kiest, heeft geen effect op de uitvoer van de opdracht.
...
- Aliassen krijgt de standaard naam.
