...
De `Wait-Job` cmdlet wacht tot Windows Power shell-achtergrond taken zijn voltooid voordat de opdracht prompt wordt weer gegeven. U kunt wachten tot een wille keurige achtergrond taak is voltooid of totdat alle achtergrond taken zijn voltooid en u een maximale wacht tijd voor de taak kunt instellen.
