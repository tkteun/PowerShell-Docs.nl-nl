...
## BESCHRIJVING
De **wacht opdracht-** cmdlet wacht totdat de Windows Power shell-achtergrond taken zijn voltooid voordat deze wordt weer gegeven.
...
Zie about_Jobs voor meer informatie over Windows Power shell-achtergrond taken.
...
Met de eerste opdracht maakt u een Windows Power shell-sessie ( **PSSession** ) op elk van de drie externe computers en slaat u deze op in de variabele $s.
...
Zie about_Remote_Variables (voor meer informatie **over de** aanpassings functie voor het bereik https://go.microsoft.com/fwlink/?LinkID=252653) .
