...
Als de opgegeven waarde dubbele aanhalings tekens ("), enkele aanhalings tekens (') of een back slash ( \\ ) bevat, moet u deze tekens weglaten door ze voor te plaatsen met het teken back slash ( \\ ). Als de opgegeven waarde gebruikmaakt van de WQL LIKE-operator, moet u de volgende tekens door geven tussen vier Kante haken ( \[ \] ): percentage (%), onderstrepings teken (_) of vier Kante haak openen ( \[ ).
