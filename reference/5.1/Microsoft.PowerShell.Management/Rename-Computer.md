...
Hiermee geeft u het protocol op dat moet worden gebruikt om de naam van de computer te wijzigen.
De acceptabele waarden voor deze para meter zijn: WSMan en DCOM.
De standaard waarde is DCOM.
