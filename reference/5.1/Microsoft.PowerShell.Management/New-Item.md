...
> [!NOTE]
> Wanneer u met deze methode een bestand maakt, wordt het resulterende bestand gecodeerd als UTF-8 zonder een byte order-Mark (BOM).
...
### Voor beeld 6: gebruik de para meter-Force om mappen opnieuw te maken
...
### Voor beeld 7: gebruik de para meter-Force om bestaande bestanden te overschrijven
