...
<span data-ttu-id="1d22e-112">De volgende tabel bevat de voorkeurs variabelen en hun standaard waarden.</span><span class="sxs-lookup"><span data-stu-id="1d22e-112">The following table lists the preference variables and their default values.</span></span>
...
<span data-ttu-id="1d22e-163">Als u het bevestigings gedrag voor alle cmdlets en functies in de sessie wilt wijzigen, wijzigt u de `$ConfirmPreference` waarde van de variabele.</span><span class="sxs-lookup"><span data-stu-id="1d22e-163">To change the confirming behavior for all cmdlets and functions in the session, change `$ConfirmPreference` variable's value.</span></span>
...
<span data-ttu-id="1d22e-196">De geldige waarden zijn als volgt:</span><span class="sxs-lookup"><span data-stu-id="1d22e-196">The valid values are as follows:</span></span>
...
<span data-ttu-id="1d22e-227">U kunt de gemeen schappelijke para meter **Error Action** van de cmdlet gebruiken om de voor keur voor een specifieke opdracht te onderdrukken.</span><span class="sxs-lookup"><span data-stu-id="1d22e-227">You can use a cmdlet's **ErrorAction** common parameter to override the preference for a specific command.</span></span>
...
<span data-ttu-id="1d22e-254">In dit voor beeld wordt de `$ErrorActionPreference` ingesteld op **SilentlyContinue**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-254">This example shows the `$ErrorActionPreference` set to **SilentlyContinue**.</span></span>
...
### <a name="errorview"></a><span data-ttu-id="1d22e-258">\$ErrorView</span><span class="sxs-lookup"><span data-stu-id="1d22e-258">\$ErrorView</span></span>
...
#### <a name="examples"></a><span data-ttu-id="1d22e-274">Voorbeelden</span><span class="sxs-lookup"><span data-stu-id="1d22e-274">Examples</span></span>
...
### <a name="formatenumerationlimit"></a><span data-ttu-id="1d22e-286">\$FormatEnumerationLimit</span><span class="sxs-lookup"><span data-stu-id="1d22e-286">\$FormatEnumerationLimit</span></span>
...
<span data-ttu-id="1d22e-299">Zoek de huidige waarde van `$FormatEnumerationLimit` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-299">Find the current value of `$FormatEnumerationLimit`.</span></span>
...
### <a name="logevent"></a><span data-ttu-id="1d22e-317">\$Logboek \* gebeurtenis</span><span class="sxs-lookup"><span data-stu-id="1d22e-317">\$Log\*Event</span></span>
...
<span data-ttu-id="1d22e-335">Als u een **logboek \* gebeurtenis** wilt inschakelen, typt u de variabele met een waarde van `$true` , bijvoorbeeld:</span><span class="sxs-lookup"><span data-stu-id="1d22e-335">To enable a **Log\*Event** , type the variable with a value of `$true`, for example:</span></span>
...
### <a name="ofs"></a><span data-ttu-id="1d22e-347">\$OFS</span><span class="sxs-lookup"><span data-stu-id="1d22e-347">\$OFS</span></span>
...
### <a name="psdefaultparametervalues"></a><span data-ttu-id="1d22e-390">\$PSDefaultParameterValues</span><span class="sxs-lookup"><span data-stu-id="1d22e-390">\$PSDefaultParameterValues</span></span>
...
<span data-ttu-id="1d22e-408">Zie [about_Modules](about_Modules.md)voor meer informatie over het automatisch importeren van modules.</span><span class="sxs-lookup"><span data-stu-id="1d22e-408">For more information about automatic importing of modules, see [about_Modules](about_Modules.md).</span></span>
...
<span data-ttu-id="1d22e-418">Als u de standaard waarden van het systeem en de waarde van deze variabele wilt negeren en een andere toepassings naam voor een bepaalde sessie wilt selecteren, gebruikt u de para meters **ConnectionURI** of **ApplicationName** van de cmdlets [New-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-PSSession](xref:Microsoft.PowerShell.Core.Enter-PSSession)of [invoke-Command](xref:Microsoft.PowerShell.Core.Invoke-Command) .</span><span class="sxs-lookup"><span data-stu-id="1d22e-418">To override the system default and the value of this variable, and select a different application name for a particular session, use the **ConnectionURI** or **ApplicationName** parameters of the [New-PSSession](xref:Microsoft.PowerShell.Core.New-PSSession), [Enter-PSSession](xref:Microsoft.PowerShell.Core.Enter-PSSession), or [Invoke-Command](xref:Microsoft.PowerShell.Core.Invoke-Command) cmdlets.</span></span>

<span data-ttu-id="1d22e-419">De `$PSSessionApplicationName` Voorkeurs variabele is ingesteld op de lokale computer, maar Hiermee wordt een listener op de externe computer opgegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-419">The `$PSSessionApplicationName` preference variable is set on the local computer, but it specifies a listener on the remote computer.</span></span> <span data-ttu-id="1d22e-420">Als de naam van de toepassing die u opgeeft niet bestaat op de externe computer, mislukt de opdracht voor het instellen van de sessie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-420">If the application name that you specify doesn't exist on the remote computer, the command to establish the session fails.</span></span>

### <a name="pssessionconfigurationname"></a><span data-ttu-id="1d22e-421">\$PSSessionConfigurationName</span><span class="sxs-lookup"><span data-stu-id="1d22e-421">\$PSSessionConfigurationName</span></span>

<span data-ttu-id="1d22e-422">Hiermee geeft u de standaard sessie configuratie op die wordt gebruikt voor **PSSessions** die zijn gemaakt in de huidige sessie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-422">Specifies the default session configuration that is used for **PSSessions** created in the current session.</span></span>

<span data-ttu-id="1d22e-423">Deze voorkeurs variabele is ingesteld op de lokale computer, maar Hiermee geeft u een sessie configuratie op die zich op de externe computer bevindt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-423">This preference variable is set on the local computer, but it specifies a session configuration that's located on the remote computer.</span></span>

<span data-ttu-id="1d22e-424">De waarde van de `$PSSessionConfigurationName` variabele is een volledig gekwalificeerde resource-URI.</span><span class="sxs-lookup"><span data-stu-id="1d22e-424">The value of the `$PSSessionConfigurationName` variable is a fully qualified resource URI.</span></span>

<span data-ttu-id="1d22e-425">De standaard waarde `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` geeft de configuratie van de **micro soft. Power shell** -sessie op de externe computer aan.</span><span class="sxs-lookup"><span data-stu-id="1d22e-425">The default value `http://schemas.microsoft.com/PowerShell/microsoft.PowerShell` indicates the **Microsoft.PowerShell** session configuration on the remote computer.</span></span>

<span data-ttu-id="1d22e-426">Als u alleen een configuratie naam opgeeft, wordt de volgende schema-URI voor het voor voegsel geplaatst:</span><span class="sxs-lookup"><span data-stu-id="1d22e-426">If you specify only a configuration name, the following schema URI is prepended:</span></span>

`http://schemas.microsoft.com/PowerShell/`

<span data-ttu-id="1d22e-427">U kunt de standaard instelling onderdrukken en een andere sessie configuratie voor een bepaalde sessie selecteren met behulp van de para meter **configuratiepad** van de `New-PSSession` `Enter-PSSession` `Invoke-Command` cmdlets, of.</span><span class="sxs-lookup"><span data-stu-id="1d22e-427">You can override the default and select a different session configuration for a particular session by using the **ConfigurationName** parameter of the `New-PSSession`, `Enter-PSSession`, or `Invoke-Command` cmdlets.</span></span>

<span data-ttu-id="1d22e-428">U kunt de waarde van deze variabele op elk gewenst moment wijzigen.</span><span class="sxs-lookup"><span data-stu-id="1d22e-428">You can change the value of this variable at any time.</span></span> <span data-ttu-id="1d22e-429">Houd er rekening mee dat de door u geselecteerde sessie configuratie op de externe computer moet bestaan.</span><span class="sxs-lookup"><span data-stu-id="1d22e-429">When you do, remember that the session configuration that you select must exist on the remote computer.</span></span> <span data-ttu-id="1d22e-430">Als dat niet het geval is, mislukt de opdracht voor het maken van een sessie die gebruikmaakt van de sessie configuratie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-430">If it doesn't, the command to create a session that uses the session configuration fails.</span></span>

<span data-ttu-id="1d22e-431">Met deze voorkeurs variabele kunt u niet bepalen welke lokale sessie configuraties worden gebruikt wanneer externe gebruikers een sessie maken die verbinding maakt met deze computer.</span><span class="sxs-lookup"><span data-stu-id="1d22e-431">This preference variable doesn't determine which local session configurations are used when remote users create a session that connects to this computer.</span></span>
<span data-ttu-id="1d22e-432">U kunt echter de machtigingen voor de lokale sessie configuraties gebruiken om te bepalen welke gebruikers ze mogen gebruiken.</span><span class="sxs-lookup"><span data-stu-id="1d22e-432">However, you can use the permissions for the local session configurations to determine which users may use them.</span></span>

### <a name="pssessionoption"></a><span data-ttu-id="1d22e-433">\$PSSessionOption</span><span class="sxs-lookup"><span data-stu-id="1d22e-433">\$PSSessionOption</span></span>

<span data-ttu-id="1d22e-434">Hiermee worden de standaard waarden voor geavanceerde gebruikers opties ingesteld in een externe sessie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-434">Establishes the default values for advanced user options in a remote session.</span></span>
<span data-ttu-id="1d22e-435">Met deze optie Voorkeuren worden de standaard waarden van het systeem voor sessie opties genegeerd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-435">These option preferences override the system default values for session options.</span></span>

<span data-ttu-id="1d22e-436">De `$PSSessionOption` variabele bevat een **PSSessionOption** -object.</span><span class="sxs-lookup"><span data-stu-id="1d22e-436">The `$PSSessionOption` variable contains a **PSSessionOption** object.</span></span> <span data-ttu-id="1d22e-437">Zie [System. Management. Automation. Remoting. PSSessionOption](/dotnet/api/system.management.automation.remoting.pssessionoption)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-437">For more information, see [System.Management.Automation.Remoting.PSSessionOption](/dotnet/api/system.management.automation.remoting.pssessionoption).</span></span>
<span data-ttu-id="1d22e-438">Elke eigenschap van het object vertegenwoordigt een sessie optie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-438">Each property of the object represents a session option.</span></span> <span data-ttu-id="1d22e-439">De eigenschap ' niet **comprimeren** ' wordt bijvoorbeeld tijdens de sessie van gegevens compressie ingeschakeld.</span><span class="sxs-lookup"><span data-stu-id="1d22e-439">For example, the **NoCompression** property turns of data compression during the session.</span></span>

<span data-ttu-id="1d22e-440">De `$PSSessionOption` variabele bevat standaard een **PSSessionOption** -object met de standaard waarden voor alle opties, zoals hieronder wordt weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-440">By default, the `$PSSessionOption` variable contains a **PSSessionOption** object with the default values for all options, as shown below.</span></span>
...
<span data-ttu-id="1d22e-441">Zie [New-PSSessionOption](xref:Microsoft.PowerShell.Core.New-PSSessionOption)voor een beschrijving van deze opties en meer informatie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-441">For descriptions of these options and more information, see [New-PSSessionOption](xref:Microsoft.PowerShell.Core.New-PSSessionOption).</span></span> <span data-ttu-id="1d22e-442">Zie [about_Remote](about_Remote.md) en [about_PSSessions](about_PSSessions.md)voor meer informatie over externe opdrachten en sessies.</span><span class="sxs-lookup"><span data-stu-id="1d22e-442">For more information about remote commands and sessions, see [about_Remote](about_Remote.md) and [about_PSSessions](about_PSSessions.md).</span></span>

<span data-ttu-id="1d22e-443">Als u de waarde van de `$PSSessionOption` Voorkeurs variabele wilt wijzigen, gebruikt `New-PSSessionOption` u de cmdlet om een **PSSessionOption** -object te maken met de optie waarden die u wilt gebruiken.</span><span class="sxs-lookup"><span data-stu-id="1d22e-443">To change the value of the `$PSSessionOption` preference variable, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object with the option values you prefer.</span></span> <span data-ttu-id="1d22e-444">Sla de uitvoer op in een variabele met de naam `$PSSessionOption` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-444">Save the output in a variable called `$PSSessionOption`.</span></span>

```powershell
$PSSessionOption = New-PSSessionOption -NoCompression
```

<span data-ttu-id="1d22e-445">Als u de `$PSSessionOption` Voorkeurs variabele in elke Power shell-sessie wilt gebruiken, voegt u een `New-PSSessionOption` opdracht toe waarmee de variabele wordt gemaakt in `$PSSessionOption` uw Power shell-profiel.</span><span class="sxs-lookup"><span data-stu-id="1d22e-445">To use the `$PSSessionOption` preference variable in every PowerShell session, add a `New-PSSessionOption` command that creates the `$PSSessionOption` variable to your PowerShell profile.</span></span> <span data-ttu-id="1d22e-446">Zie [about_Profiles](about_Profiles.md)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-446">For more information, see [about_Profiles](about_Profiles.md).</span></span>

<span data-ttu-id="1d22e-447">U kunt aangepaste opties instellen voor een bepaalde externe sessie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-447">You can set custom options for a particular remote session.</span></span> <span data-ttu-id="1d22e-448">De opties die u instelt, hebben voor rang op de standaard waarden van het systeem en de waarde van de `$PSSessionOption` Voorkeurs variabele.</span><span class="sxs-lookup"><span data-stu-id="1d22e-448">The options that you set take precedence over the system defaults and the value of the `$PSSessionOption` preference variable.</span></span>

<span data-ttu-id="1d22e-449">Als u aangepaste sessie opties wilt instellen, gebruikt u de `New-PSSessionOption` cmdlet om een **PSSessionOption** -object te maken.</span><span class="sxs-lookup"><span data-stu-id="1d22e-449">To set custom session options, use the `New-PSSessionOption` cmdlet to create a **PSSessionOption** object.</span></span> <span data-ttu-id="1d22e-450">Gebruik vervolgens het object **PSSessionOption** als de waarde van de para meter **SessionOption** in cmdlets die een sessie maken, zoals `New-PSSession` , `Enter-PSSession` , en `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-450">Then, use the **PSSessionOption** object as the value of the **SessionOption** parameter in cmdlets that create a session, such as `New-PSSession`, `Enter-PSSession`, and `Invoke-Command`.</span></span>

### <a name="transcript"></a><span data-ttu-id="1d22e-451">$Transcript</span><span class="sxs-lookup"><span data-stu-id="1d22e-451">$Transcript</span></span>

<span data-ttu-id="1d22e-452">Wordt gebruikt door `Start-Transcript` om de naam en locatie van het transcript-bestand op te geven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-452">Used by `Start-Transcript` to specify the name and location of the transcript file.</span></span> <span data-ttu-id="1d22e-453">Als u geen waarde opgeeft voor de para meter **Path** , `Start-Transcript` wordt het pad gebruikt in de waarde van de `$Transcript` globale variabele.</span><span class="sxs-lookup"><span data-stu-id="1d22e-453">If you do not specify a value for the **Path** parameter, `Start-Transcript` uses the path in the value of the `$Transcript` global variable.</span></span> <span data-ttu-id="1d22e-454">Als u deze variabele niet hebt gemaakt, `Start-Transcript` slaat de transcripten in de `$Home\My Documents` map op als `\PowerShell_transcript.<time-stamp>.txt` bestanden.</span><span class="sxs-lookup"><span data-stu-id="1d22e-454">If you have not created this variable, `Start-Transcript` stores the transcripts in the `$Home\My Documents` directory as `\PowerShell_transcript.<time-stamp>.txt` files.</span></span>

### <a name="verbosepreference"></a><span data-ttu-id="1d22e-455">\$VerbosePreference</span><span class="sxs-lookup"><span data-stu-id="1d22e-455">\$VerbosePreference</span></span>

<span data-ttu-id="1d22e-456">Bepaalt hoe Power shell reageert op uitgebreide berichten die zijn gegenereerd door een script, cmdlet of provider, zoals de berichten die door de cmdlet [Write-verbose](xref:Microsoft.PowerShell.Utility.Write-Verbose) worden gegenereerd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-456">Determines how PowerShell responds to verbose messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Verbose](xref:Microsoft.PowerShell.Utility.Write-Verbose) cmdlet.</span></span>
<span data-ttu-id="1d22e-457">Uitgebreide berichten beschrijven de acties die worden uitgevoerd om een opdracht uit te voeren.</span><span class="sxs-lookup"><span data-stu-id="1d22e-457">Verbose messages describe the actions performed to execute a command.</span></span>

<span data-ttu-id="1d22e-458">Standaard worden uitgebreide berichten niet weer gegeven, maar u kunt dit gedrag wijzigen door de waarde van te wijzigen `$VerbosePreference` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-458">By default, verbose messages aren't displayed, but you can change this behavior by changing the value of `$VerbosePreference`.</span></span>

<span data-ttu-id="1d22e-459">U kunt de **uitgebreide** algemene para meter van een cmdlet gebruiken om de uitgebreide berichten voor een specifieke opdracht weer te geven of te verbergen.</span><span class="sxs-lookup"><span data-stu-id="1d22e-459">You can use the **Verbose** common parameter of a cmdlet to display or hide the verbose messages for a specific command.</span></span> <span data-ttu-id="1d22e-460">Zie [about_CommonParameters](about_CommonParameters.md)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-460">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="1d22e-461">De geldige waarden zijn als volgt:</span><span class="sxs-lookup"><span data-stu-id="1d22e-461">The valid values are as follows:</span></span>

- <span data-ttu-id="1d22e-462">**Stoppen** : Hiermee wordt het uitgebreide bericht en een fout bericht weer gegeven en wordt de uitvoering gestopt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-462">**Stop** : Displays the verbose message and an error message and then stops executing.</span></span>
- <span data-ttu-id="1d22e-463">**Query** : Hiermee wordt het uitgebreide bericht weer gegeven en wordt er een prompt weer gegeven waarin u wordt gevraagd of u wilt door gaan.</span><span class="sxs-lookup"><span data-stu-id="1d22e-463">**Inquire** : Displays the verbose message and then displays a prompt that asks you whether you want to continue.</span></span>
- <span data-ttu-id="1d22e-464">**Door gaan** : Hiermee wordt het uitgebreide bericht weer gegeven en wordt de uitvoering voortgezet.</span><span class="sxs-lookup"><span data-stu-id="1d22e-464">**Continue** : Displays the verbose message and then continues with execution.</span></span>
- <span data-ttu-id="1d22e-465">**SilentlyContinue** : (standaard) geeft het uitgebreide bericht niet weer.</span><span class="sxs-lookup"><span data-stu-id="1d22e-465">**SilentlyContinue** : (Default) Doesn't display the verbose message.</span></span> <span data-ttu-id="1d22e-466">Gaat verder met uitvoeren.</span><span class="sxs-lookup"><span data-stu-id="1d22e-466">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="1d22e-467">Voorbeelden</span><span class="sxs-lookup"><span data-stu-id="1d22e-467">Examples</span></span>

<span data-ttu-id="1d22e-468">In deze voor beelden ziet u het effect van de verschillende waarden van `$VerbosePreference` en de **uitgebreide** para meter om de voorkeurs waarde te overschrijven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-468">These examples show the effect of the different values of `$VerbosePreference` and the **Verbose** parameter to override the preference value.</span></span>

<span data-ttu-id="1d22e-469">In dit voor beeld ziet u het effect van de **SilentlyContinue** -waarde. Dit is de standaard instelling.</span><span class="sxs-lookup"><span data-stu-id="1d22e-469">This example shows the effect of the **SilentlyContinue** value, that is the default.</span></span> <span data-ttu-id="1d22e-470">De opdracht gebruikt de para meter **bericht** , maar schrijft geen bericht naar de Power shell-console.</span><span class="sxs-lookup"><span data-stu-id="1d22e-470">The command uses the **Message** parameter, but doesn't write a message to the PowerShell console.</span></span>

```powershell
Write-Verbose -Message "Verbose message test."
```

<span data-ttu-id="1d22e-471">Wanneer de **uitgebreide** para meter wordt gebruikt, wordt het bericht geschreven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-471">When the **Verbose** parameter is used, the message is written.</span></span>
...
<span data-ttu-id="1d22e-472">In dit voor beeld ziet u het effect van de waarde **continue** .</span><span class="sxs-lookup"><span data-stu-id="1d22e-472">This example shows the effect of the **Continue** value.</span></span> <span data-ttu-id="1d22e-473">De `$VerbosePreference` variabele is ingesteld om **door te gaan** en het bericht wordt weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-473">The `$VerbosePreference` variable is set to **Continue** and the message is displayed.</span></span>
...
<span data-ttu-id="1d22e-474">In dit voor beeld wordt de **uitgebreide** para meter met de waarde van `$false` vervangen door de waarde **continue** .</span><span class="sxs-lookup"><span data-stu-id="1d22e-474">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Continue** value.</span></span> <span data-ttu-id="1d22e-475">Het bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-475">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="1d22e-476">In dit voor beeld wordt het effect van de waarde **Stop** weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-476">This example shows the effect of the **Stop** value.</span></span> <span data-ttu-id="1d22e-477">De `$VerbosePreference` variabele wordt ingesteld op **stoppen** en het bericht wordt weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-477">The `$VerbosePreference` variable is set to **Stop** and the message is displayed.</span></span> <span data-ttu-id="1d22e-478">De opdracht is gestopt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-478">The command is stopped.</span></span>
...
<span data-ttu-id="1d22e-479">In dit voor beeld wordt de para meter **uitgebreid** gebruikt met de waarde `$false` die de **Stop** waarde overschrijft.</span><span class="sxs-lookup"><span data-stu-id="1d22e-479">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Stop** value.</span></span> <span data-ttu-id="1d22e-480">Het bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-480">The message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

<span data-ttu-id="1d22e-481">In dit voor beeld ziet u het effect van de waarde van de **query** .</span><span class="sxs-lookup"><span data-stu-id="1d22e-481">This example shows the effect of the **Inquire** value.</span></span> <span data-ttu-id="1d22e-482">De `$VerbosePreference` variabele is ingesteld op **query's**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-482">The `$VerbosePreference` variable is set to **Inquire**.</span></span> <span data-ttu-id="1d22e-483">Het bericht wordt weer gegeven en de gebruiker wordt om bevestiging gevraagd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-483">The message is displayed and the user is prompted for confirmation.</span></span>
...
<span data-ttu-id="1d22e-484">In dit voor beeld wordt de **uitgebreide** para meter met de waarde van `$false` vervangen door de waarde van de **query** .</span><span class="sxs-lookup"><span data-stu-id="1d22e-484">This example uses the **Verbose** parameter with a value of `$false` that overrides the **Inquire** value.</span></span> <span data-ttu-id="1d22e-485">De gebruiker wordt niet gevraagd en het bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-485">The user isn't prompted and the message isn't displayed.</span></span>

```powershell
Write-Verbose -Message "Verbose message test." -Verbose:$false
```

### <a name="warningpreference"></a><span data-ttu-id="1d22e-486">\$WarningPreference</span><span class="sxs-lookup"><span data-stu-id="1d22e-486">\$WarningPreference</span></span>

<span data-ttu-id="1d22e-487">Bepaalt hoe Power shell reageert op waarschuwings berichten die worden gegenereerd door een script, cmdlet of provider, zoals de berichten die worden gegenereerd door de cmdlet [Write-Warning](xref:Microsoft.PowerShell.Utility.Write-Warning) .</span><span class="sxs-lookup"><span data-stu-id="1d22e-487">Determines how PowerShell responds to warning messages generated by a script, cmdlet, or provider, such as the messages generated by the [Write-Warning](xref:Microsoft.PowerShell.Utility.Write-Warning) cmdlet.</span></span>

<span data-ttu-id="1d22e-488">Standaard worden waarschuwings berichten weer gegeven en de uitvoering wordt voortgezet, maar u kunt dit gedrag wijzigen door de waarde van te wijzigen `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-488">By default, warning messages are displayed and execution continues, but you can change this behavior by changing the value of `$WarningPreference`.</span></span>

<span data-ttu-id="1d22e-489">U kunt de algemene para meter **WarningAction** van een cmdlet gebruiken om te bepalen hoe Power shell reageert op waarschuwingen van een bepaalde opdracht.</span><span class="sxs-lookup"><span data-stu-id="1d22e-489">You can use the **WarningAction** common parameter of a cmdlet to determine how PowerShell responds to warnings from a particular command.</span></span> <span data-ttu-id="1d22e-490">Zie [about_CommonParameters](about_CommonParameters.md)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="1d22e-490">For more information, see [about_CommonParameters](about_CommonParameters.md).</span></span>

<span data-ttu-id="1d22e-491">De geldige waarden zijn als volgt:</span><span class="sxs-lookup"><span data-stu-id="1d22e-491">The valid values are as follows:</span></span>

- <span data-ttu-id="1d22e-492">**Stoppen** : Hiermee wordt het waarschuwings bericht en een fout bericht weer gegeven en wordt de uitvoering gestopt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-492">**Stop** : Displays the warning message and an error message and then stops executing.</span></span>
- <span data-ttu-id="1d22e-493">**Query** : geeft het waarschuwings bericht weer en vraagt om toestemming om door te gaan.</span><span class="sxs-lookup"><span data-stu-id="1d22e-493">**Inquire** : Displays the warning message and then prompts for permission to continue.</span></span>
- <span data-ttu-id="1d22e-494">**Door gaan** : (standaard) Hiermee wordt het waarschuwings bericht weer gegeven en wordt de uitvoering voortgezet.</span><span class="sxs-lookup"><span data-stu-id="1d22e-494">**Continue** : (Default) Displays the warning message and then continues executing.</span></span>
- <span data-ttu-id="1d22e-495">**SilentlyContinue** : het waarschuwings bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-495">**SilentlyContinue** : Doesn't display the warning message.</span></span> <span data-ttu-id="1d22e-496">Gaat verder met uitvoeren.</span><span class="sxs-lookup"><span data-stu-id="1d22e-496">Continues executing.</span></span>

#### <a name="examples"></a><span data-ttu-id="1d22e-497">Voorbeelden</span><span class="sxs-lookup"><span data-stu-id="1d22e-497">Examples</span></span>

<span data-ttu-id="1d22e-498">In deze voor beelden ziet u het effect van de verschillende waarden van `$WarningPreference` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-498">These examples show the effect of the different values of `$WarningPreference`.</span></span>
<span data-ttu-id="1d22e-499">De para meter **WarningAction** overschrijft de voorkeurs waarde.</span><span class="sxs-lookup"><span data-stu-id="1d22e-499">The **WarningAction** parameter overrides the preference value.</span></span>

<span data-ttu-id="1d22e-500">In dit voor **beeld wordt het** effect van de standaard waarde weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-500">This example shows the effect of the default value, **Continue**.</span></span>
...
<span data-ttu-id="1d22e-501">In dit voor beeld wordt de para meter **WarningAction** gebruikt met de waarde **SilentlyContinue** om de waarschuwing te onderdrukken.</span><span class="sxs-lookup"><span data-stu-id="1d22e-501">This example uses the **WarningAction** parameter with the value **SilentlyContinue** to suppress the warning.</span></span> <span data-ttu-id="1d22e-502">Het bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-502">The message isn't displayed.</span></span>
...
<span data-ttu-id="1d22e-503">In dit voor beeld wordt de `$WarningPreference` variabele gewijzigd in de waarde **SilentlyContinue** .</span><span class="sxs-lookup"><span data-stu-id="1d22e-503">This example changes the `$WarningPreference` variable to the **SilentlyContinue** value.</span></span> <span data-ttu-id="1d22e-504">Het bericht wordt niet weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-504">The message isn't displayed.</span></span>
...
<span data-ttu-id="1d22e-505">In dit voor beeld wordt de para meter **WarningAction** gebruikt om te stoppen wanneer een waarschuwing wordt gegenereerd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-505">This example uses the **WarningAction** parameter to stop when a warning is generated.</span></span>
...
<span data-ttu-id="1d22e-506">In dit voor beeld wordt de `$WarningPreference` variabele gewijzigd in de **query** waarde.</span><span class="sxs-lookup"><span data-stu-id="1d22e-506">This example changes the `$WarningPreference` variable to the **Inquire** value.</span></span> <span data-ttu-id="1d22e-507">De gebruiker wordt gevraagd om bevestiging.</span><span class="sxs-lookup"><span data-stu-id="1d22e-507">The user is prompted for confirmation.</span></span>
...
<span data-ttu-id="1d22e-508">In dit voor beeld wordt de para meter **WarningAction** gebruikt met de waarde **SilentlyContinue**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-508">This example uses the **WarningAction** parameter with the value **SilentlyContinue**.</span></span> <span data-ttu-id="1d22e-509">De opdracht blijft uitvoeren en er wordt geen bericht weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-509">The command continues to execute and no message is displayed.</span></span>
...
<span data-ttu-id="1d22e-510">In dit voor beeld wordt de `$WarningPreference` te **stoppen** waarde gewijzigd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-510">This example changes the `$WarningPreference` value to **Stop**.</span></span>
...
<span data-ttu-id="1d22e-511">In dit voor beeld wordt de **WarningAction** gebruikt met de **query** waarde.</span><span class="sxs-lookup"><span data-stu-id="1d22e-511">This example uses the **WarningAction** with the **Inquire** value.</span></span> <span data-ttu-id="1d22e-512">De gebruiker wordt gevraagd wanneer een waarschuwing wordt weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-512">The user is prompted when a warning occurs.</span></span>
...
### <a name="whatifpreference"></a><span data-ttu-id="1d22e-513">\$WhatIfPreference</span><span class="sxs-lookup"><span data-stu-id="1d22e-513">\$WhatIfPreference</span></span>

<span data-ttu-id="1d22e-514">Hiermee wordt bepaald of **WhatIf** automatisch wordt ingeschakeld voor elke opdracht die het ondersteunt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-514">Determines whether **WhatIf** is automatically enabled for every command that supports it.</span></span> <span data-ttu-id="1d22e-515">Wanneer **WhatIf** is ingeschakeld, rapporteert de cmdlet het verwachte effect van de opdracht, maar voert de-opdracht niet uit.</span><span class="sxs-lookup"><span data-stu-id="1d22e-515">When **WhatIf** is enabled, the cmdlet reports the expected effect of the command, but doesn't execute the command.</span></span>

<span data-ttu-id="1d22e-516">De geldige waarden zijn als volgt:</span><span class="sxs-lookup"><span data-stu-id="1d22e-516">The valid values are as follows:</span></span>

- <span data-ttu-id="1d22e-517">**False** ( **0** , niet ingeschakeld): (standaard) **WhatIf** is niet automatisch ingeschakeld.</span><span class="sxs-lookup"><span data-stu-id="1d22e-517">**False** ( **0** , not enabled): (Default) **WhatIf** isn't automatically enabled.</span></span> <span data-ttu-id="1d22e-518">Als u deze hand matig wilt inschakelen, gebruikt u de para meter **WhatIf** van de cmdlet.</span><span class="sxs-lookup"><span data-stu-id="1d22e-518">To enable it manually, use the cmdlet's **WhatIf** parameter.</span></span>
- <span data-ttu-id="1d22e-519">**True** ( **1** , ingeschakeld): **WhatIf** wordt automatisch ingeschakeld voor alle opdrachten die dit ondersteunen.</span><span class="sxs-lookup"><span data-stu-id="1d22e-519">**True** ( **1** , enabled): **WhatIf** is automatically enabled on any command that supports it.</span></span> <span data-ttu-id="1d22e-520">Gebruikers kunnen de para meter **WhatIf** gebruiken met de waarde **False** om deze hand matig uit te scha kelen, zoals `-WhatIf:$false` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-520">Users can use the **WhatIf** parameter with a value of **False** to disable it manually, such as `-WhatIf:$false`.</span></span>

#### <a name="examples"></a><span data-ttu-id="1d22e-521">Voorbeelden</span><span class="sxs-lookup"><span data-stu-id="1d22e-521">Examples</span></span>

<span data-ttu-id="1d22e-522">In deze voor beelden ziet u het effect van de verschillende waarden van `$WhatIfPreference` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-522">These examples show the effect of the different values of `$WhatIfPreference`.</span></span>
<span data-ttu-id="1d22e-523">Ze laten zien hoe u de para meter **WhatIf** kunt gebruiken om de voorkeurs waarde voor een specifieke opdracht te overschrijven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-523">They show how to use the **WhatIf** parameter to override the preference value for a specific command.</span></span>

<span data-ttu-id="1d22e-524">In dit voor beeld wordt het effect van de `$WhatIfPreference` variabele ingesteld op de standaard waarde, **Onwaar**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-524">This example shows the effect of the `$WhatIfPreference` variable set to the default value, **False**.</span></span> <span data-ttu-id="1d22e-525">Gebruiken `Get-ChildItem` om te controleren of het bestand bestaat.</span><span class="sxs-lookup"><span data-stu-id="1d22e-525">Use `Get-ChildItem` to verify that the file exists.</span></span>
<span data-ttu-id="1d22e-526">`Remove-Item` Hiermee verwijdert u het bestand.</span><span class="sxs-lookup"><span data-stu-id="1d22e-526">`Remove-Item` deletes the file.</span></span> <span data-ttu-id="1d22e-527">Nadat het bestand is verwijderd, kunt u de verwijdering controleren met `Get-ChildItem` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-527">After the file is deleted, you can verify the deletion with `Get-ChildItem`.</span></span>
...
<span data-ttu-id="1d22e-528">In dit voor beeld ziet u het effect van het gebruik van de para meter **WhatIf** wanneer de waarde van is ingesteld op `$WhatIfPreference` **False**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-528">This example shows the effect of using the **WhatIf** parameter when the value of `$WhatIfPreference` is **False**.</span></span>

<span data-ttu-id="1d22e-529">Controleer of het bestand bestaat.</span><span class="sxs-lookup"><span data-stu-id="1d22e-529">Verify that the file exists.</span></span>
...
<span data-ttu-id="1d22e-530">Gebruik de para meter **WhatIf** om het resultaat van de poging om het bestand te verwijderen te bepalen.</span><span class="sxs-lookup"><span data-stu-id="1d22e-530">Use the **WhatIf** parameter to determine the result of attempting to delete the file.</span></span>
...
<span data-ttu-id="1d22e-531">Controleer of het bestand niet is verwijderd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-531">Verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="1d22e-532">In dit voor beeld ziet u het effect van de `$WhatIfPreference` variabele die is ingesteld op de waarde **True**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-532">This example shows the effect of the `$WhatIfPreference` variable set to the value, **True**.</span></span> <span data-ttu-id="1d22e-533">Wanneer u gebruikt `Remove-Item` om een bestand te verwijderen, wordt het pad van het bestand weer gegeven, maar wordt het bestand niet verwijderd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-533">When you use `Remove-Item` to delete a file, the file's path is displayed, but the file isn't deleted.</span></span>

<span data-ttu-id="1d22e-534">Poging een bestand te verwijderen.</span><span class="sxs-lookup"><span data-stu-id="1d22e-534">Attempt to delete a file.</span></span> <span data-ttu-id="1d22e-535">Er wordt een bericht weer gegeven over wat er zou gebeuren als `Remove-Item` het programma werd uitgevoerd, maar het bestand wordt niet verwijderd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-535">A message is displayed about what would happen if `Remove-Item` was run, but the file isn't deleted.</span></span>
...
<span data-ttu-id="1d22e-536">Gebruiken `Get-ChildItem` om te controleren of het bestand niet is verwijderd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-536">Use `Get-ChildItem` to verify that the file wasn't deleted.</span></span>
...
<span data-ttu-id="1d22e-537">In dit voor beeld ziet u hoe u een bestand verwijdert wanneer de waarde van is ingesteld op `$WhatIfPreference` **True**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-537">This example shows how to delete a file when the value of `$WhatIfPreference` is **True**.</span></span> <span data-ttu-id="1d22e-538">De para meter **WhatIf** wordt gebruikt met de waarde `$false` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-538">It uses the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="1d22e-539">Gebruiken `Get-ChildItem` om te controleren of het bestand is verwijderd.</span><span class="sxs-lookup"><span data-stu-id="1d22e-539">Use `Get-ChildItem` to verify the file was deleted.</span></span>
...
<span data-ttu-id="1d22e-540">Hier volgen enkele voor beelden van de `Get-Process` cmdlet die geen ondersteuning biedt voor **WhatIf** en `Stop-Process` die **WhatIf** ondersteunt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-540">The following are examples of the `Get-Process` cmdlet that doesn't support **WhatIf** and `Stop-Process` that does support **WhatIf**.</span></span> <span data-ttu-id="1d22e-541">De `$WhatIfPreference` waarde van de variabele is **waar**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-541">The `$WhatIfPreference` variable's value is **True**.</span></span>

<span data-ttu-id="1d22e-542">`Get-Process` biedt geen ondersteuning voor **WhatIf**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-542">`Get-Process` doesn't support **WhatIf**.</span></span> <span data-ttu-id="1d22e-543">Wanneer de opdracht wordt uitgevoerd, wordt het **Winword** -proces weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="1d22e-543">When the command is executed, it displays the **Winword** process.</span></span>
...
<span data-ttu-id="1d22e-544">`Stop-Process` biedt ondersteuning voor **WhatIf**.</span><span class="sxs-lookup"><span data-stu-id="1d22e-544">`Stop-Process` does support **WhatIf**.</span></span> <span data-ttu-id="1d22e-545">Het **Winword** -proces is niet gestopt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-545">The **Winword** process isn't stopped.</span></span>
...
<span data-ttu-id="1d22e-546">U kunt het `Stop-Process` gedrag van de **WhatIf** negeren door de para meter **WhatIf** te gebruiken met de waarde `$false` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-546">You can override the `Stop-Process` **WhatIf** behavior by using the **WhatIf** parameter with a value of `$false`.</span></span> <span data-ttu-id="1d22e-547">Het **Winword** -proces is gestopt.</span><span class="sxs-lookup"><span data-stu-id="1d22e-547">The **Winword** process is stopped.</span></span>

```powershell
Stop-Process -Name Winword -WhatIf:$false
```

<span data-ttu-id="1d22e-548">Gebruik om te controleren of het proces **Winword** is gestopt `Get-Process` .</span><span class="sxs-lookup"><span data-stu-id="1d22e-548">To verify that the **Winword** process was stopped, use `Get-Process`.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="1d22e-549">Zie ook</span><span class="sxs-lookup"><span data-stu-id="1d22e-549">See also</span></span>

[<span data-ttu-id="1d22e-550">about_Automatic_Variables</span><span class="sxs-lookup"><span data-stu-id="1d22e-550">about_Automatic_Variables</span></span>](about_Automatic_Variables.md)

[<span data-ttu-id="1d22e-551">about_CommonParameters</span><span class="sxs-lookup"><span data-stu-id="1d22e-551">about_CommonParameters</span></span>](about_CommonParameters.md)

[<span data-ttu-id="1d22e-552">about_Environment_Variables</span><span class="sxs-lookup"><span data-stu-id="1d22e-552">about_Environment_Variables</span></span>](about_Environment_Variables.md)

[<span data-ttu-id="1d22e-553">about_Profiles</span><span class="sxs-lookup"><span data-stu-id="1d22e-553">about_Profiles</span></span>](about_Profiles.md)

[<span data-ttu-id="1d22e-554">about_Remote</span><span class="sxs-lookup"><span data-stu-id="1d22e-554">about_Remote</span></span>](about_Remote.md)

[<span data-ttu-id="1d22e-555">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="1d22e-555">about_Scopes</span></span>](about_Scopes.md)

[<span data-ttu-id="1d22e-556">about_Variables</span><span class="sxs-lookup"><span data-stu-id="1d22e-556">about_Variables</span></span>](about_Variables.md)
