...
- <span data-ttu-id="bce9d-121">`Get-Alias` -Haalt alle aliassen in de huidige sessie op.</span><span class="sxs-lookup"><span data-stu-id="bce9d-121">`Get-Alias` - Gets all the aliases in the current session.</span></span>
