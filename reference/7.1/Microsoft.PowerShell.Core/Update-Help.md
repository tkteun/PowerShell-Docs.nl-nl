...
> [!IMPORTANT]
> `Update-Help` hiervoor zijn beheerders bevoegdheden in Power shell 6,0 en lager vereist.
> In Power shell 6,1 en hoger wordt het standaard **bereik** ingesteld op `CurrentUser` .
> Vóór Power shell 6,1 is de **bereik** parameter niet beschikbaar.
>
...
> Bijvoorbeeld: `Start-Process pwsh.exe -Verb RunAs`.
...
### Voor beeld 4: Help-bestanden op meerdere computers bijwerken vanuit een bestands share
...
### Voor beeld 5: een lijst met bijgewerkte Help-bestanden ophalen
...
### Voor beeld 6: modules zoeken die kunnen worden bijgewerkt met ondersteuning
...
### Voor beeld 7: inventaris bijgewerkte Help-bestanden
...
Hiermee geeft u het systeem bereik op waar Help wordt bijgewerkt. Voor updates in het **ALLUSERS** -bereik zijn beheerders bevoegdheden op Windows-systemen vereist. De `-Scope` para meter is geïntroduceerd in Power shell core versie 6,1.

**CurrentUser** is het standaard bereik voor Help-bestanden in power shell 6,1 en hoger. **ALLUSERS** kan worden opgegeven om Help voor alle gebruikers te installeren of bij te werken. Op UNIX-systeem `sudo` privileges zijn vereist om Help bij te werken voor alle gebruikers. Bijvoorbeeld: `sudo pwsh -c Update-Help`
