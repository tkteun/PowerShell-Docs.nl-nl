...
De cmdlet **Connect-PSSession** maakt opnieuw verbinding met door gebruikers beheerde Power shell-sessies ( **PSSessions** ) die zijn losgekoppeld.
...
Zie about_Remote_Disconnected_Sessions voor meer informatie over de functie voor verbroken sessies.
...
Standaard worden verbindingen niet door Power shell omgeleid, maar u kunt deze para meter gebruiken om de verbinding te omleiden.
...
Als u de standaard poorten voor externe communicatie van Power shell wilt gebruiken, geeft u poort 5985 voor HTTP of 5986 op voor HTTPS.
...
Als u de listener wilt configureren, typt u de volgende twee opdrachten bij de Power shell-prompt:
