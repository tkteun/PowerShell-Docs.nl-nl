...
De teken reeks `This is a test` wordt verzonden naar de pijp lijn. `Export-Clixml` maakt gebruik van de para meter **Path** voor het maken van een XML-bestand met `sample.xml` de naam in de huidige map.
