...
### <span data-ttu-id="d9b8d-107">StandardMethodNoProxy</span><span class="sxs-lookup"><span data-stu-id="d9b8d-107">StandardMethodNoProxy</span></span>
...
## <span data-ttu-id="d9b8d-110">Description</span><span class="sxs-lookup"><span data-stu-id="d9b8d-110">Description</span></span>
...
## <span data-ttu-id="d9b8d-157">Parameters</span><span class="sxs-lookup"><span data-stu-id="d9b8d-157">Parameters</span></span>
...
<span data-ttu-id="d9b8d-170">Beschikbare verificatieopties:</span><span class="sxs-lookup"><span data-stu-id="d9b8d-170">Available Authentication Options:</span></span>
...
### <span data-ttu-id="d9b8d-195">-Certificaat</span><span class="sxs-lookup"><span data-stu-id="d9b8d-195">-Certificate</span></span>
...
<span data-ttu-id="d9b8d-213">Hiermee geeft u een gebruikersaccount op dat toestemming heeft om de aanvraag te verzenden.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-213">Specifies a user account that has permission to send the request.</span></span> <span data-ttu-id="d9b8d-214">Standaard is dit de huidige gebruiker.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-214">The default is the current user.</span></span>
...
<span data-ttu-id="d9b8d-225">Voorbeeld:</span><span class="sxs-lookup"><span data-stu-id="d9b8d-225">Example:</span></span>
...
<span data-ttu-id="d9b8d-285">Geeft aan dat de cmdlet geen proxy gebruikt om de bestemming te bereiken.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-285">Indicates that the cmdlet will not use a proxy to reach the destination.</span></span>
...
### <span data-ttu-id="d9b8d-296">-PassThru</span><span class="sxs-lookup"><span data-stu-id="d9b8d-296">-PassThru</span></span>
...
### <span data-ttu-id="d9b8d-304">-Proxy</span><span class="sxs-lookup"><span data-stu-id="d9b8d-304">-Proxy</span></span>
...
### <span data-ttu-id="d9b8d-314">-ProxyUseDefaultCredentials</span><span class="sxs-lookup"><span data-stu-id="d9b8d-314">-ProxyUseDefaultCredentials</span></span>
...
### <span data-ttu-id="d9b8d-322">-Hervatten</span><span class="sxs-lookup"><span data-stu-id="d9b8d-322">-Resume</span></span>
...
<span data-ttu-id="d9b8d-356">Deze functie is toegevoegd in PowerShell 6.0.0.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-356">This feature was added in PowerShell 6.0.0.</span></span>
...
<span data-ttu-id="d9b8d-365">Deze parameter zorgt ervoor dat de cmdlet HTTP-foutstatussen negeert en antwoorden blijft verwerken.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-365">This parameter causes the cmdlet to ignore HTTP error statuses and continue to process responses.</span></span>
...
### <span data-ttu-id="d9b8d-386">-TimeoutSec</span><span class="sxs-lookup"><span data-stu-id="d9b8d-386">-TimeoutSec</span></span>
...
<span data-ttu-id="d9b8d-408">Deze parameter is vereist.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-408">This parameter is required.</span></span> <span data-ttu-id="d9b8d-409">De parameternaam (**URI**) is optioneel.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-409">The parameter name (**Uri**) is optional.</span></span>
...
<span data-ttu-id="d9b8d-411">Deze parameter is afgeschaft.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-411">This parameter has been deprecated.</span></span> <span data-ttu-id="d9b8d-412">Vanaf PowerShell 6.0.0 gebruiken alle webaanvragen alleen basisparsering.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-412">Beginning with PowerShell 6.0.0, all Web requests use basic parsing only.</span></span> <span data-ttu-id="d9b8d-413">Deze parameter is alleen opgenomen voor achterwaartse compatibiliteit en elk gebruik ervan heeft geen invloed op de werking van de cmdlet.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-413">This parameter is included for backwards compatibility only and any use of it will have no effect on the operation of the cmdlet.</span></span>
...
### <span data-ttu-id="d9b8d-414">-UseDefaultCredentials</span><span class="sxs-lookup"><span data-stu-id="d9b8d-414">-UseDefaultCredentials</span></span>

<span data-ttu-id="d9b8d-415">Geeft aan dat de cmdlet de referenties van de huidige gebruiker gebruikt om de webaanvraag te verzenden.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-415">Indicates that the cmdlet uses the credentials of the current user to send the web request.</span></span> <span data-ttu-id="d9b8d-416">Dit kan niet worden gebruikt met **verificatie of** **referentie** en wordt mogelijk niet ondersteund op alle platforms.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-416">This can't be used with **Authentication** or **Credential** and may not be supported on all platforms.</span></span>
...
### <span data-ttu-id="d9b8d-417">-UserAgent</span><span class="sxs-lookup"><span data-stu-id="d9b8d-417">-UserAgent</span></span>

<span data-ttu-id="d9b8d-418">Hiermee geeft u een tekenreeks voor de gebruikersagent op voor de webaanvraag.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-418">Specifies a user agent string for the web request.</span></span>

<span data-ttu-id="d9b8d-419">De standaardgebruikersagent is vergelijkbaar met `Mozilla/5.0 (Windows NT 10.0; Microsoft Windows 10.0.15063; en-US) PowerShell/6.0.0` met kleine variaties voor elk besturingssysteem en platform.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-419">The default user agent is similar to `Mozilla/5.0 (Windows NT 10.0; Microsoft Windows 10.0.15063; en-US) PowerShell/6.0.0` with slight variations for each operating system and platform.</span></span>

<span data-ttu-id="d9b8d-420">Als u een website wilt testen met de standaard tekenreeks van de gebruikersagent die door de meeste internetbrowsers wordt gebruikt, gebruikt u de eigenschappen van de [klasse PSUserAgent,](/dotnet/api/microsoft.powershell.commands.psuseragent) zoals Chrome, FireFox, InternetExplorer, Opera en Safari.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-420">To test a website with the standard user agent string that is used by most internet browsers, use the properties of the [PSUserAgent](/dotnet/api/microsoft.powershell.commands.psuseragent) class, such as Chrome, FireFox, InternetExplorer, Opera, and Safari.</span></span>
...
### <span data-ttu-id="d9b8d-421">-WebSession</span><span class="sxs-lookup"><span data-stu-id="d9b8d-421">-WebSession</span></span>

<span data-ttu-id="d9b8d-422">Hiermee geeft u een webaanvraagsessie.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-422">Specifies a web request session.</span></span> <span data-ttu-id="d9b8d-423">Voer de naam van de variabele in, inclusief het dollarteken ( `$` ).</span><span class="sxs-lookup"><span data-stu-id="d9b8d-423">Enter the variable name, including the dollar sign (`$`).</span></span>

<span data-ttu-id="d9b8d-424">Als u een waarde in de webaanvraagsessie wilt overschrijven, gebruikt u een cmdlet-parameter, zoals **UserAgent** of **Credential.**</span><span class="sxs-lookup"><span data-stu-id="d9b8d-424">To override a value in the web request session, use a cmdlet parameter, such as **UserAgent** or **Credential**.</span></span> <span data-ttu-id="d9b8d-425">Parameterwaarden hebben voorrang op waarden in de webaanvraagsessie.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-425">Parameter values take precedence over values in the web request session.</span></span> <span data-ttu-id="d9b8d-426">Inhoudsgerelateerde headers, zoals , worden ook overschrijven wanneer een `Content-Type` **MultipartFormDataContent-object** wordt opgegeven voor **Hoofdtekst.**</span><span class="sxs-lookup"><span data-stu-id="d9b8d-426">Content related headers, such as `Content-Type`, will be also be overridden when a **MultipartFormDataContent** object is supplied for **Body**.</span></span>

<span data-ttu-id="d9b8d-427">In tegenstelling tot een externe sessie is de webaanvraagsessie geen permanente verbinding.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-427">Unlike a remote session, the web request session isn't a persistent connection.</span></span> <span data-ttu-id="d9b8d-428">Het is een object dat informatie bevat over de verbinding en de aanvraag, inclusief cookies, referenties, de maximale omleidingswaarde en de tekenreeks van de gebruikersagent.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-428">It's an object that contains information about the connection and the request, including cookies, credentials, the maximum redirection value, and the user agent string.</span></span> <span data-ttu-id="d9b8d-429">U kunt deze gebruiken om de status en gegevens te delen tussen webaanvragen.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-429">You can use it to share state and data among web requests.</span></span>

<span data-ttu-id="d9b8d-430">Als u een webaanvraagsessie wilt maken, voert u een variabelenaam in, zonder dollarteken, in de waarde van de parameter **SessionVariable** van een `Invoke-RestMethod` opdracht.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-430">To create a web request session, enter a variable name, without a dollar sign, in the value of the **SessionVariable** parameter of an `Invoke-RestMethod` command.</span></span> <span data-ttu-id="d9b8d-431">`Invoke-RestMethod` maakt de sessie en slaat deze op in de variabele .</span><span class="sxs-lookup"><span data-stu-id="d9b8d-431">`Invoke-RestMethod` creates the session and saves it in the variable.</span></span> <span data-ttu-id="d9b8d-432">In volgende opdrachten gebruikt u de variabele als de waarde van de parameter **WebSession.**</span><span class="sxs-lookup"><span data-stu-id="d9b8d-432">In subsequent commands, use the variable as the value of the **WebSession** parameter.</span></span>

<span data-ttu-id="d9b8d-433">U kunt de parameters **SessionVariable en** **WebSession** niet gebruiken in dezelfde opdracht.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-433">You can't use the **SessionVariable** and **WebSession** parameters in the same command.</span></span>
...
### <span data-ttu-id="d9b8d-434">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="d9b8d-434">CommonParameters</span></span>

<span data-ttu-id="d9b8d-435">Deze cmdlet biedt ondersteuning voor de meest gebruikte parameters: -Debug, - ErrorAction, - ErrorVariable, - InformationAction, -InformationVariable, - OutVariable,-OutBuffer, - PipelineVariable - Verbose, - WarningAction en -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-435">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="d9b8d-436">Zie voor meer informatie [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="d9b8d-436">For more information, see [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="d9b8d-437">Invoerwaarden</span><span class="sxs-lookup"><span data-stu-id="d9b8d-437">Inputs</span></span>

### <span data-ttu-id="d9b8d-438">System.Object</span><span class="sxs-lookup"><span data-stu-id="d9b8d-438">System.Object</span></span>

<span data-ttu-id="d9b8d-439">U kunt de body van een webaanvraag doorseen naar `Invoke-RestMethod` .</span><span class="sxs-lookup"><span data-stu-id="d9b8d-439">You can pipe the body of a web request to `Invoke-RestMethod`.</span></span>

## <span data-ttu-id="d9b8d-440">Uitvoerwaarden</span><span class="sxs-lookup"><span data-stu-id="d9b8d-440">Outputs</span></span>

### <span data-ttu-id="d9b8d-441">System.Int64, System.String, System.Xml.XmlDocument</span><span class="sxs-lookup"><span data-stu-id="d9b8d-441">System.Int64, System.String, System.Xml.XmlDocument</span></span>

<span data-ttu-id="d9b8d-442">De uitvoer van de cmdlet is afhankelijk van de indeling van de inhoud die wordt opgehaald.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-442">The output of the cmdlet depends upon the format of the content that is retrieved.</span></span>

### <span data-ttu-id="d9b8d-443">PSObject</span><span class="sxs-lookup"><span data-stu-id="d9b8d-443">PSObject</span></span>

<span data-ttu-id="d9b8d-444">Als de aanvraag JSON-tekenreeksen retourneert, `Invoke-RestMethod` retourneert een **PSObject** dat de tekenreeksen vertegenwoordigt.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-444">If the request returns JSON strings, `Invoke-RestMethod` returns a **PSObject** that represents the strings.</span></span>

## <span data-ttu-id="d9b8d-445">Notities</span><span class="sxs-lookup"><span data-stu-id="d9b8d-445">Notes</span></span>

<span data-ttu-id="d9b8d-446">Sommige functies zijn mogelijk niet op alle platforms beschikbaar.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-446">Some features may not be available on all platforms.</span></span>

<span data-ttu-id="d9b8d-447">Vanwege wijzigingen in .NET Core 3.1 gebruikt PowerShell 7.0 en hoger de eigenschap [HttpClient.DefaultProxy](/dotnet/api/system.net.http.httpclient.defaultproxy?view=netcore-3.1) om de proxyconfiguratie te bepalen.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-447">Because of changes in .NET Core 3.1, PowerShell 7.0 and higher use the [HttpClient.DefaultProxy](/dotnet/api/system.net.http.httpclient.defaultproxy?view=netcore-3.1) Property to determine the proxy configuration.</span></span>

<span data-ttu-id="d9b8d-448">De waarde van deze eigenschap is afhankelijk van uw platform:</span><span class="sxs-lookup"><span data-stu-id="d9b8d-448">The value of this property is different rules depending on your platform:</span></span>

- <span data-ttu-id="d9b8d-449">**Voor Windows:** leest proxyconfiguratie uit omgevingsvariabelen of, als deze niet zijn gedefinieerd, uit de proxy-instellingen van de gebruiker.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-449">**For Windows**: Reads proxy configuration from environment variables or, if those are not defined, from the user's proxy settings.</span></span>
- <span data-ttu-id="d9b8d-450">**Voor macOS:** leest proxyconfiguratie uit omgevingsvariabelen of, als deze niet zijn gedefinieerd, vanuit de proxy-instellingen van het systeem.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-450">**For macOS**: Reads proxy configuration from environment variables or, if those are not defined, from the system's proxy settings.</span></span>
- <span data-ttu-id="d9b8d-451">**Voor Linux:** leest proxyconfiguratie uit omgevingsvariabelen of, als deze niet zijn gedefinieerd, initialiseert deze eigenschap een niet-geconfigureerd exemplaar dat alle adressen omzeilt.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-451">**For Linux**: Reads proxy configuration from environment variables or, in case those are not defined, this property initializes a non-configured instance that bypasses all addresses.</span></span>

<span data-ttu-id="d9b8d-452">De omgevingsvariabelen die worden gebruikt `DefaultProxy` voor initialisatie op Windows- en Unix-platforms zijn:</span><span class="sxs-lookup"><span data-stu-id="d9b8d-452">The environment variables used for `DefaultProxy` initialization on Windows and Unix-based platforms are:</span></span>

- <span data-ttu-id="d9b8d-453">`HTTP_PROXY`: de hostnaam of het IP-adres van de proxyserver die wordt gebruikt voor HTTP-aanvragen.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-453">`HTTP_PROXY`: the hostname or IP address of the proxy server used on HTTP requests.</span></span>
- <span data-ttu-id="d9b8d-454">`HTTPS_PROXY`: de hostnaam of het IP-adres van de proxyserver die wordt gebruikt voor HTTPS-aanvragen.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-454">`HTTPS_PROXY`: the hostname or IP address of the proxy server used on HTTPS requests.</span></span>
- <span data-ttu-id="d9b8d-455">`ALL_PROXY`: de hostnaam of het IP-adres van de proxyserver die wordt gebruikt voor HTTP- en HTTPS-aanvragen voor het geval `HTTP_PROXY` of `HTTPS_PROXY` niet zijn gedefinieerd.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-455">`ALL_PROXY`: the hostname or IP address of the proxy server used on HTTP and HTTPS requests in case `HTTP_PROXY` or `HTTPS_PROXY` are not defined.</span></span>
- <span data-ttu-id="d9b8d-456">`NO_PROXY`: een door komma's gescheiden lijst met hostnamen die moeten worden uitgesloten van proxying.</span><span class="sxs-lookup"><span data-stu-id="d9b8d-456">`NO_PROXY`: a comma-separated list of hostnames that should be excluded from proxying.</span></span>

## <span data-ttu-id="d9b8d-457">Verwante koppelingen</span><span class="sxs-lookup"><span data-stu-id="d9b8d-457">Related Links</span></span>

[<span data-ttu-id="d9b8d-458">ConvertTo-Json</span><span class="sxs-lookup"><span data-stu-id="d9b8d-458">ConvertTo-Json</span></span>](ConvertTo-Json.md)

[<span data-ttu-id="d9b8d-459">ConvertFrom-Json</span><span class="sxs-lookup"><span data-stu-id="d9b8d-459">ConvertFrom-Json</span></span>](ConvertFrom-Json.md)

[<span data-ttu-id="d9b8d-460">Invoke-WebRequest</span><span class="sxs-lookup"><span data-stu-id="d9b8d-460">Invoke-WebRequest</span></span>](Invoke-WebRequest.md)
