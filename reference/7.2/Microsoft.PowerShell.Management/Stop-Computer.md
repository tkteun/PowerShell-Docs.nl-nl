...
In Power shell 7,1 `Stop-Computer` is toegevoegd voor Linux en macOS. De para meters hebben geen effect op deze platforms. De cmdlet roept alleen de systeem eigen opdracht aan `/sbin/shutdown` .
...
In Power shell 7,1 `Stop-Computer` is toegevoegd voor Linux en macOS. Voor deze platorms roept de cmdlet de systeem eigen opdracht aan `/sbin/shutdown` .
