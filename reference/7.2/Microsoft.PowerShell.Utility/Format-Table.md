...
Vanaf Power shell 6 worden de standaard weergaven gedefinieerd in Power shell- `C#` bron code. De `*.format.ps1xml` bestanden van de Power shell 5,1 en eerdere versies bestaan niet in Power shell 6 en hoger.
