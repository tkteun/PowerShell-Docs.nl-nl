...
### <span data-ttu-id="cbcd7-107">StandardMethodNoProxy</span><span class="sxs-lookup"><span data-stu-id="cbcd7-107">StandardMethodNoProxy</span></span>
...
### <span data-ttu-id="cbcd7-122">Voor beeld 2: een stateful webservice gebruiken</span><span class="sxs-lookup"><span data-stu-id="cbcd7-122">Example 2: Use a stateful web service</span></span>
...
<span data-ttu-id="cbcd7-132">Op de aanroep `$ProfileResponse` zelf wordt de `BasicHtmlWebResponseObject` in de variabele weer gegeven.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-132">The call to `$ProfileResponse` by itself shows the `BasicHtmlWebResponseObject` in the variable.</span></span>
...
<span data-ttu-id="cbcd7-142">Met de laatste opdrachten wordt de eigenschap **Content** geschreven naar het bestand en vervolgens verwijderd `StreamWriter` .</span><span class="sxs-lookup"><span data-stu-id="cbcd7-142">The final few commands write the **Content** property to the file then disposes the `StreamWriter`.</span></span>
...
### <span data-ttu-id="cbcd7-218">-Credential</span><span class="sxs-lookup"><span data-stu-id="cbcd7-218">-Credential</span></span>
...
### <span data-ttu-id="cbcd7-237">-Vorm</span><span class="sxs-lookup"><span data-stu-id="cbcd7-237">-Form</span></span>
...
### <span data-ttu-id="cbcd7-261">-Inbestand</span><span class="sxs-lookup"><span data-stu-id="cbcd7-261">-InFile</span></span>
...
<span data-ttu-id="cbcd7-270">Hiermee geeft u op hoe vaak Power shell een verbinding probeert te verbreken wanneer een fout code tussen 400 en 599, inclusief of 304 wordt ontvangen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-270">Specifies how many times PowerShell retries a connection when a failure code between 400 and 599, inclusive or 304 is received.</span></span> <span data-ttu-id="cbcd7-271">Zie ook de para meter **RetryIntervalSec** voor het opgeven van het aantal nieuwe pogingen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-271">Also see **RetryIntervalSec** parameter for specifying number of retries.</span></span>
...
<span data-ttu-id="cbcd7-305">Deze functie is toegevoegd aan Power shell 6.0.0.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-305">This feature was added in PowerShell 6.0.0.</span></span>
...
<span data-ttu-id="cbcd7-320">Hiermee wordt een beste poging gedaan om het downloaden van een gedeeltelijk bestand te hervatten.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-320">Performs a best effort attempt to resume downloading a partial file.</span></span> <span data-ttu-id="cbcd7-321">Voor **hervatten** is **outfile** vereist.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-321">**Resume** requires **OutFile**.</span></span>
...
### <span data-ttu-id="cbcd7-332">-RetryIntervalSec</span><span class="sxs-lookup"><span data-stu-id="cbcd7-332">-RetryIntervalSec</span></span>
...
<span data-ttu-id="cbcd7-363">Deze para meter zorgt ervoor dat de cmdlet HTTP-fout statussen negeert en de antwoorden blijft verwerken.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-363">This parameter causes the cmdlet to ignore HTTP error statuses and continue to process responses.</span></span>
...
<span data-ttu-id="cbcd7-374">Deze functie is toegevoegd aan Power shell 6.0.0 en ondersteuning voor `Tls13` is toegevoegd in Power shell 7,1.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-374">This feature was added in PowerShell 6.0.0 and support for `Tls13` was added in PowerShell 7.1.</span></span>
...
### <span data-ttu-id="cbcd7-394">-URI</span><span class="sxs-lookup"><span data-stu-id="cbcd7-394">-Uri</span></span>
...
<span data-ttu-id="cbcd7-405">Geeft aan dat de cmdlet de referenties van de huidige gebruiker gebruikt om de webaanvraag te verzenden.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-405">Indicates that the cmdlet uses the credentials of the current user to send the web request.</span></span> <span data-ttu-id="cbcd7-406">Deze kan niet worden gebruikt met **verificatie** of **referentie** en wordt mogelijk niet ondersteund op alle platforms.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-406">This can't be used with **Authentication** or **Credential** and may not be supported on all platforms.</span></span>
...
### <span data-ttu-id="cbcd7-412">-Websessie</span><span class="sxs-lookup"><span data-stu-id="cbcd7-412">-WebSession</span></span>
...
<span data-ttu-id="cbcd7-426">Deze cmdlet biedt ondersteuning voor de meest gebruikte parameters: -Debug, - ErrorAction, - ErrorVariable, - InformationAction, -InformationVariable, - OutVariable,-OutBuffer, - PipelineVariable - Verbose, - WarningAction en -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-426">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="cbcd7-427">Zie [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-427">For more information, see [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="cbcd7-428">INVOER</span><span class="sxs-lookup"><span data-stu-id="cbcd7-428">INPUTS</span></span>

### <span data-ttu-id="cbcd7-429">System. object</span><span class="sxs-lookup"><span data-stu-id="cbcd7-429">System.Object</span></span>

<span data-ttu-id="cbcd7-430">U kunt de hoofd tekst van een webaanvraag door sluizen naar `Invoke-WebRequest` .</span><span class="sxs-lookup"><span data-stu-id="cbcd7-430">You can pipe the body of a web request to `Invoke-WebRequest`.</span></span>

## <span data-ttu-id="cbcd7-431">UITVOER</span><span class="sxs-lookup"><span data-stu-id="cbcd7-431">OUTPUTS</span></span>

### <span data-ttu-id="cbcd7-432">Micro soft. Power shell. commands. BasicHtmlWebResponseObject</span><span class="sxs-lookup"><span data-stu-id="cbcd7-432">Microsoft.PowerShell.Commands.BasicHtmlWebResponseObject</span></span>

## <span data-ttu-id="cbcd7-433">OPMERKINGEN</span><span class="sxs-lookup"><span data-stu-id="cbcd7-433">NOTES</span></span>

<span data-ttu-id="cbcd7-434">Vanaf Power shell 6.0.0 `Invoke-WebRequest` ondersteunt alleen basis parsering.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-434">Beginning with PowerShell 6.0.0 `Invoke-WebRequest` supports basic parsing only.</span></span>

<span data-ttu-id="cbcd7-435">Zie [BasicHtmlWebResponseObject](/dotnet/api/microsoft.powershell.commands.basichtmlwebresponseobject)voor meer informatie.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-435">For more information, see [BasicHtmlWebResponseObject](/dotnet/api/microsoft.powershell.commands.basichtmlwebresponseobject).</span></span>

<span data-ttu-id="cbcd7-436">Vanwege wijzigingen in .NET Core 3,1, Power shell 7,0 en hoger, gebruikt u de eigenschap [httpclient maakt. DefaultProxy](/dotnet/api/system.net.http.httpclient.defaultproxy?view=netcore-3.1) om de proxy configuratie te bepalen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-436">Because of changes in .NET Core 3.1, PowerShell 7.0 and higher use the [HttpClient.DefaultProxy](/dotnet/api/system.net.http.httpclient.defaultproxy?view=netcore-3.1) Property to determine the proxy configuration.</span></span>

<span data-ttu-id="cbcd7-437">De waarde van deze eigenschap wordt bepaald door uw platform:</span><span class="sxs-lookup"><span data-stu-id="cbcd7-437">The value of this property is determined by your platform:</span></span>

- <span data-ttu-id="cbcd7-438">**Voor Windows**: Hiermee leest u de proxy configuratie van omgevings variabelen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-438">**For Windows**: Reads proxy configuration from environment variables.</span></span> <span data-ttu-id="cbcd7-439">Als deze variabelen niet worden gedefinieerd, wordt de eigenschap afgeleid van de proxy-instellingen van de gebruiker.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-439">If those variables are not defined the property is derived from the user's proxy settings.</span></span>
- <span data-ttu-id="cbcd7-440">**Voor macOS**: leest de proxy configuratie van omgevings variabelen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-440">**For macOS**: Reads proxy configuration from environment variables.</span></span> <span data-ttu-id="cbcd7-441">Als deze variabelen niet worden gedefinieerd, wordt de eigenschap afgeleid van de proxy-instellingen van het systeem.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-441">If those variables are not defined the property is derived from the system's proxy settings.</span></span>
- <span data-ttu-id="cbcd7-442">**Voor Linux**: Hiermee leest u de proxy configuratie van omgevings variabelen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-442">**For Linux**: Reads proxy configuration from environment variables.</span></span> <span data-ttu-id="cbcd7-443">Als deze variabelen niet zijn gedefinieerd, initialiseert de eigenschap een niet-geconfigureerd exemplaar dat alle adressen omzeilt.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-443">If those variables are not defined the property initializes a non-configured instance that bypasses all addresses.</span></span>

<span data-ttu-id="cbcd7-444">De omgevings variabelen die worden gebruikt voor de `DefaultProxy` initialisatie op Windows-en UNIX-platforms zijn:</span><span class="sxs-lookup"><span data-stu-id="cbcd7-444">The environment variables used for `DefaultProxy` initialization on Windows and Unix-based platforms are:</span></span>

- <span data-ttu-id="cbcd7-445">` HTTP_PROXY`: de hostnaam of het IP-adres van de proxy server die wordt gebruikt voor HTTP-aanvragen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-445">` HTTP_PROXY`: the hostname or IP address of the proxy server used on HTTP requests.</span></span>
- <span data-ttu-id="cbcd7-446">`HTTPS_PROXY`: de hostnaam of het IP-adres van de proxy server die wordt gebruikt voor HTTPS-aanvragen.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-446">`HTTPS_PROXY`: the hostname or IP address of the proxy server used on HTTPS requests.</span></span>
- <span data-ttu-id="cbcd7-447">`ALL_PROXY`: de hostnaam of het IP-adres van de proxy server die wordt gebruikt voor HTTP-en HTTPS-aanvragen `HTTP_PROXY` of `HTTPS_PROXY` die niet zijn gedefinieerd.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-447">`ALL_PROXY`: the hostname or IP address of the proxy server used on HTTP and HTTPS requests in case `HTTP_PROXY` or `HTTPS_PROXY` are not defined.</span></span>
- <span data-ttu-id="cbcd7-448">`NO_PROXY`: een door komma's gescheiden lijst met hostnamen die moeten worden uitgesloten van de proxy.</span><span class="sxs-lookup"><span data-stu-id="cbcd7-448">`NO_PROXY`: a comma-separated list of hostnames that should be excluded from proxying.</span></span>

## <span data-ttu-id="cbcd7-449">GERELATEERDE KOPPELINGEN</span><span class="sxs-lookup"><span data-stu-id="cbcd7-449">RELATED LINKS</span></span>

[<span data-ttu-id="cbcd7-450">Invoke-RestMethod</span><span class="sxs-lookup"><span data-stu-id="cbcd7-450">Invoke-RestMethod</span></span>](Invoke-RestMethod.md)

[<span data-ttu-id="cbcd7-451">ConvertFrom-JSON</span><span class="sxs-lookup"><span data-stu-id="cbcd7-451">ConvertFrom-Json</span></span>](ConvertFrom-Json.md)

[<span data-ttu-id="cbcd7-452">ConvertTo-Json</span><span class="sxs-lookup"><span data-stu-id="cbcd7-452">ConvertTo-Json</span></span>](ConvertTo-Json.md)
