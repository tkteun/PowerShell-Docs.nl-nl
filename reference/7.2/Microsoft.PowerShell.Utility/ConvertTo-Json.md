...
Hiermee geeft u op hoeveel niveaus van ingesloten objecten zijn opgenomen in de JSON-weergave. De waarde kan elk getal van tot `0` `[Int]::MaxValue` zijn. De standaardwaarde is `2`. `ConvertTo-Json` geeft een waarschuwing weer als het aantal niveaus in een invoerobject dit aantal overschrijdt.
