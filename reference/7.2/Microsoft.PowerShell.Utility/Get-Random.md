...
U kunt de para meters van gebruiken `Get-Random` om een Seed-nummer, minimum-en maximum waarden op te geven, het aantal objecten dat door een ingediende verzameling wordt geretourneerd en de volledige verzameling in een wille keurige volg orde.
