...
Als u de *InstanceId* van een taak wilt ophalen, voert u de cmdlet **Get-job** uit, pijpleidingt u de resultaten in een **indeling-** _ cmdlet, zoals weer gegeven in het volgende voor beeld:
...
De eenvoudigste manier om deze para meter te gebruiken is het opslaan van de resultaten van een _ *Get-job**-opdracht die de actieve taak retourneert die u wilt opsporen in een variabele. vervolgens geeft u de variabele op als de waarde van deze para meter.
...
{{Opvulling BreakAll beschrijving}}
