...
<span data-ttu-id="32e98-111">Hieronder ziet u de `ForEach` syntaxis:</span><span class="sxs-lookup"><span data-stu-id="32e98-111">The following shows the `ForEach` syntax:</span></span>
