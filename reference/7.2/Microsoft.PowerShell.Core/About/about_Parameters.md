...
De `Get-ChildItem` cmdlet heeft bijvoorbeeld Path-en exclude-para meters. De `Position` instelling voor het **pad** is **0**, wat betekent dat het een positionele para meter is. De `Position` instelling voor **uitsluiten** heet .
