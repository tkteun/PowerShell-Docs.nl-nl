...
<a name="stop-dscconfiguration-may-hang-in-debugmode"></a>Stop-DscConfiguration loopt vast in fouten opsporen-modus
------------------------------------------------------------------------------------------------------------------------
Als LCM fouten opsporen-modus, loopt Stop-DscConfiguration vast tijdens het stoppen van een bewerking aan de slag door Get-DscConfiguration
