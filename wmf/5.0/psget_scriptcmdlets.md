...
---
# <a name="powershellget-cmdlets-for-script-management"></a>Cmdlets voor het scriptbeheer van het PowerShellGet
...
## <a name="uninstall-script-cmdlet"></a>De cmdlet Uninstall-Script
```powershell
