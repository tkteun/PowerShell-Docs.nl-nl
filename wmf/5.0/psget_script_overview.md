...
ms.locfileid: "55686969"
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="7166b-102">PowerShell-Script detecteren, installeren en beheren met PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="7166b-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="7166b-103">Functie voor het delen van PowerShell-Script is toegevoegd aan de PowerShellGet in de WMF 5.0 RTM-versie.</span><span class="sxs-lookup"><span data-stu-id="7166b-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="7166b-104">De volgende nieuwe-cmdlets zijn toegevoegd aan de PowerShellGet-module voor de ondersteuning van de PowerShell-Scripts.</span><span class="sxs-lookup"><span data-stu-id="7166b-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="7166b-105">De syntaxis van script-Cmdlets voor delen:</span><span class="sxs-lookup"><span data-stu-id="7166b-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
