...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a>Detectie PowerShell-scripts, installatie en beheer met PowerShellGet
...
De syntaxis van de script-Cmdlets voor delen:
```powershell
