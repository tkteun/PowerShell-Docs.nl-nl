...
---
# <a name="installation-of-module-dependencies"></a><span data-ttu-id="b4c70-102">Installatie van module-afhankelijkheden</span><span class="sxs-lookup"><span data-stu-id="b4c70-102">Installation of Module Dependencies</span></span>

<span data-ttu-id="b4c70-103">Er is nu side-by-side (SxS)-module versie-ondersteuning in Install-Module, Update-Module en Publish-Module-cmdlets die worden uitgevoerd in Windows PowerShell 5.0 of hoger.</span><span class="sxs-lookup"><span data-stu-id="b4c70-103">There is now side-by-side (SxS) module version support in Install-Module, Update-Module, and Publish-Module cmdlets that run in Windows PowerShell 5.0 or newer.</span></span>
<span data-ttu-id="b4c70-104">We hebben ook een parameter - RequiredVersion toegevoegd aan de cmdlet Publish-Module om op te geven van de versie moet worden gepubliceerd.</span><span class="sxs-lookup"><span data-stu-id="b4c70-104">Also, we have added a -RequiredVersion parameter to the Publish-Module cmdlet to specify the version to be published.</span></span> <span data-ttu-id="b4c70-105">De parameter Path ondersteunt nu het basispad module met de versie-map.</span><span class="sxs-lookup"><span data-stu-id="b4c70-105">The Path parameter now supports the module base path with the version folder.</span></span>

<span data-ttu-id="b4c70-106">**Voorbeelden van Install-Module:**</span><span class="sxs-lookup"><span data-stu-id="b4c70-106">**Install-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="b4c70-107">**Een module met afhankelijkheden installeren:**</span><span class="sxs-lookup"><span data-stu-id="b4c70-107">**Install a module with dependencies:**</span></span>
```powershell
PS C:\windows\system32> Get-InstalledModule
...
<span data-ttu-id="b4c70-108">**Inhoud van de module ModuleWithDependencies2 manifestbestand:**</span><span class="sxs-lookup"><span data-stu-id="b4c70-108">**Contents of ModuleWithDependencies2 module manifest file:**</span></span>
```powershell
@{
...
<span data-ttu-id="b4c70-109">**Voorbeelden van de update-Module:**</span><span class="sxs-lookup"><span data-stu-id="b4c70-109">**Update-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="b4c70-110">**Voorbeelden van publiceren-Module:**</span><span class="sxs-lookup"><span data-stu-id="b4c70-110">**Publish-Module examples:**</span></span>
```powershell
