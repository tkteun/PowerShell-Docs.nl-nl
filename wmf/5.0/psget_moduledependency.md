...
---
# <a name="installation-of-module-dependencies"></a>Installatie van de Module-afhankelijkheden
...
**Een module met afhankelijkheden installeren:**
```powershell
PS C:\\windows\\system32&gt; Get-InstalledModule
...
**Inhoud van de module ModuleWithDependencies2 manifestbestand:**
```powershell
@{
...
**Voorbeelden van de update-Module:**
```powershell
...
**Voorbeelden van publiceren-Module:**
```powershell
