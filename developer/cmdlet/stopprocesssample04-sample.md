...
Dit voorbeeld laat zien hoe u een cmdlet die parametersets verklaart, geeft u de standaardparameter ingesteld, en u kunt een invoerobject schrijft. Deze cmdlet is vergelijkbaar met de `Stop-Process` cmdlet geleverd door Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Over het bouwen van het voorbeeld met behulp van Visual Studio.

1. Met de Windows PowerShell 2.0 SDK is geïnstalleerd, gaat u naar de map StopProcessSample04. De standaardlocatie is C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Een parameter die invoerobject accepteert toe te voegen.

- Toe te voegen parameters parametersets

- Stelt u de standaardparameter op te geven.

## <a name="example"></a>Voorbeeld

De volgende code toont een implementatie van de cmdlet Stop-Proc waarin parametersets declareren, Hiermee geeft u de standaardparameter instellen en een invoerobject kan accepteren.

In dit voorbeeld leest het invoerobject, parametersets declareren, en geeft u de standaardparameter ingesteld voor het gebruik.
