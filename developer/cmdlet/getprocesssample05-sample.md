...
In dit voorbeeld ziet u een volledige versie van de cmdlet Get-Proc.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Over het bouwen van het voorbeeld met behulp van Visual Studio.

1. Open Windows Verkenner en navigeer naar de map GetProcessSample05 onder de map Samples.

   Met de Windows PowerShell 2.0 SDK is geïnstalleerd, gaat u naar de map GetProcessSample05. De standaardlocatie is C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
- Functies voor parameters opgeven.

- Op te geven dat parameters duren invoer van de pijplijn voordat kunnen. De invoer kan worden uitgevoerd van een object of een waarde van een eigenschap van een object waarvan de de eigenschapsnaam hetzelfde als de naam van de parameter is.
...
Dit voorbeeld laat zien hoe u een cmdlet die een lijst weer van de opgegeven processen geeft maken.
