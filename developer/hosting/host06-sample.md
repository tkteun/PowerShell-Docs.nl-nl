...
- Deze klassen host een consoletoepassing bouwen die worden gebruikt voor het bouwen van een interactieve Windows PowerShell-shell.

- Het maken van een `$profile` variabele en het laden van de volgende profielen.

  - huidige gebruiker, de huidige host

  - huidige gebruiker, alle hosts

  - alle gebruikers, de huidige host

  - alle gebruikers, alle hosts

- Implementeer de [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.

- Implementeer de [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface voor de ondersteuning van interactieve voor externe toegang met behulp van de [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) en [ Afsluiten PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.
- Implementeer de [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface voor de ondersteuning van interactieve voor externe toegang met behulp van de [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) en [ Afsluiten PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.

- De API basisvormen gebruiken voor het inkleuren van de opdrachtregel, terwijl deze wordt getypt.

## <a name="example"></a>Voorbeeld

 In dit voorbeeld kan de gebruiker voert opdrachten op de opdrachtregel, die opdrachten verwerkt en vervolgens de resultaten worden afgedrukt.
...
## <a name="example"></a>Voorbeeld
 ...
 De volgende code is de implementatie van de [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) klasse die wordt gebruikt door deze hosttoepassing. Deze elementen die niet worden geïmplementeerd een uitzondering of niets retourneren.
...
## <a name="example"></a>Voorbeeld
 ...
 De volgende code is de implementatie van de [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) klasse die wordt gebruikt door deze hosttoepassing.
...
## <a name="example"></a>Voorbeeld
 ...
 De volgende code is de implementatie van de [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) klasse die wordt gebruikt door deze hosttoepassing. Deze elementen die niet worden geïmplementeerd een uitzondering of niets retourneren.
...
## <a name="example"></a>Voorbeeld
 ...
 De volgende code leest de opdrachtregel en kleuren de tekst worden ingevoerd. Tokens worden bepaald met behulp van de [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) methode.
