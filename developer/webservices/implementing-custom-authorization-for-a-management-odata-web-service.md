...
---
# <a name="implementing-custom-authorization-for-a-management-odata-web-service"></a><span data-ttu-id="3a81d-102">Aangepaste autorisatie implementeren voor een Management OData-webservice</span><span class="sxs-lookup"><span data-stu-id="3a81d-102">Implementing Custom Authorization for a Management OData web service</span></span>

<span data-ttu-id="3a81d-103">Een derde partij te implementeren met behulp van de Windows PowerShell-webservice vereist de [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface om beschikbaar te stellen van Windows PowerShell-cmdlets.</span><span class="sxs-lookup"><span data-stu-id="3a81d-103">Using the Windows PowerShell Web Service requires a third party to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface to expose Windows PowerShell cmdlets.</span></span> <span data-ttu-id="3a81d-104">Deze interface voert gebruikersautorisatie met de webservice.</span><span class="sxs-lookup"><span data-stu-id="3a81d-104">This interface performs user authorization to the web service.</span></span> <span data-ttu-id="3a81d-105">Na het schrijven van de code voor het implementeren van de interface, moet u het compileren in een DLL-bestand moet worden gebruikt in de web-App.</span><span class="sxs-lookup"><span data-stu-id="3a81d-105">After writing the code to implement the interface, you must compile it into a DLL to be used in the web application.</span></span>

## <a name="pass-through-authorization"></a><span data-ttu-id="3a81d-106">Pass through-verificatie</span><span class="sxs-lookup"><span data-stu-id="3a81d-106">Pass-through authorization</span></span>

<span data-ttu-id="3a81d-107">De eenvoudigste manier voor het implementeren van de [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface is een Pass Through-implementatie die alle gebruikers worden geautoriseerd.</span><span class="sxs-lookup"><span data-stu-id="3a81d-107">The simplest way to implement the [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface is a pass-through implementation that authorizes all users.</span></span> <span data-ttu-id="3a81d-108">In dit voorbeeld biedt geen beveiliging en s alleen beschikbaar als een llustration van hoe u de interface te implementeren.</span><span class="sxs-lookup"><span data-stu-id="3a81d-108">This example provides no security, and s provided only as an llustration of how to implement the interface.</span></span> <span data-ttu-id="3a81d-109">Een implementatie van de [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface moet twee methoden overschrijven: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) en [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span><span class="sxs-lookup"><span data-stu-id="3a81d-109">An implementation of the  [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) interface must override two methods: [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId).</span></span> <span data-ttu-id="3a81d-110">In dit voorbeeld wordt de [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) retourneert altijd de **System.Security.Principal.WindowsIdentity** object dat is gekoppeld aan de huidige gebruiker .</span><span class="sxs-lookup"><span data-stu-id="3a81d-110">In this example, the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) always returns the **System.Security.Principal.WindowsIdentity** object associated with the current user.</span></span>
...
### <a name="role-based-authorization"></a><span data-ttu-id="3a81d-111">Autorisatie op basis van rollen</span><span class="sxs-lookup"><span data-stu-id="3a81d-111">Role-based authorization</span></span>

<span data-ttu-id="3a81d-112">Het volgende voorbeeld wordt een autorisatiebeleid op basis van rollen voor geïmplementeerd.</span><span class="sxs-lookup"><span data-stu-id="3a81d-112">The following example implements a role-based authorization policy.</span></span> <span data-ttu-id="3a81d-113">Het beleid is gedefinieerd in een XML-bestand dat zich in de map van het hoofdvenster van de toepassing met het bestand web.config bevindt en MOF- en XML-toewijzing van schema-bestanden.</span><span class="sxs-lookup"><span data-stu-id="3a81d-113">The policy is defined in an XML file that resides in the main application directory with the web.config and MOF and XML mapping schema files.</span></span> <span data-ttu-id="3a81d-114">Zie voor meer informatie over het configureren van het bestand met autorisatieregels schema [autorisatie op basis van rollen configureren](./configuring-role-based-authorization.md).</span><span class="sxs-lookup"><span data-stu-id="3a81d-114">For information about how to configure the authorization schema file, see [Configuring Role-based Authorization](./configuring-role-based-authorization.md).</span></span> <span data-ttu-id="3a81d-115">Het eerste deel van het voorbeeld implementeert de [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) en [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) methoden.</span><span class="sxs-lookup"><span data-stu-id="3a81d-115">The first part of the sample implements the [Microsoft.Management.Odata.Customauthorization.Authorizeuser\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.AuthorizeUser) and [Microsoft.Management.Odata.Customauthorization.Getmembershipid\*](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization.GetMembershipId) methods.</span></span> <span data-ttu-id="3a81d-116">In dit geval de interfacemethoden methoden aanroepen de `RbacSystem` klasse (hieronder gedefinieerd) die daadwerkelijk werken van de machtigingen voor de gebruiker controleren.</span><span class="sxs-lookup"><span data-stu-id="3a81d-116">In this case, the interface methods call methods in the `RbacSystem` class (defined below) that do the actual work of checking the permissions for the user.</span></span>
...
<span data-ttu-id="3a81d-117">Het volgende voorbeeld wordt een klasse die wordt geparseerd autorisatiebeleid in het XML-bestand.</span><span class="sxs-lookup"><span data-stu-id="3a81d-117">The following example creates a class that parses authorization policy in the XML file.</span></span>
...
```
 ...
 <span data-ttu-id="3a81d-118">De volgende klassen vertegenwoordigen groepen en gebruikers, respectievelijk.</span><span class="sxs-lookup"><span data-stu-id="3a81d-118">The following classes represent groups and users, respectively.</span></span>
