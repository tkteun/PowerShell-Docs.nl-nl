...
Management OData IIS-extensie gebruikt XML-bestanden voor het definiëren van de toewijzing. De volgende XSD definieert het schema voor deze bestanden.

## <a name="resource-mapping-file-xsd"></a>Resource-toewijzingsbestand XSD

De volgende XSD definieert het schema voor de toewijzing van bronbestanden Management OData IIS-extensie.
